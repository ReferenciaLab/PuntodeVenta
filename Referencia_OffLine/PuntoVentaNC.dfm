inherited frmPuntoVentaNC: TfrmPuntoVentaNC
  Caption = 'Facturacion Punto de Venta (NOTA CREDITO)'
  ClientHeight = 574
  ClientWidth = 1048
  KeyPreview = True
  ...
  object dxLayoutControl1: TdxLayoutControl [2]
      ...
      object TabGeneral: TcxTabSheet
        ...
        object lcGeneral: TdxLayoutControl
          ...
          object EDDIAGN: TcxDBExtLookupComboBox
            Left = 656
            Top = 171
            RepositoryItem = DM.elcDiagnostico
    ...
    object GridPruebas: TcxGrid
      ...
      object GridPruebasEntradasPacienteDet: TcxGridDBTableView
        ...
        object GridPruebasEntradasPacienteDetSeleccion: TcxGridDBColumn
          Caption = 'Sel.'
          DataBinding.FieldName = 'NCR_ESTATUS'
          Width = 29
        end
  ...
  object dsPago: TDataSource [9]
    Left = 657
    Top = 304
  end
  object qrEntradaPaciente: TADOQuery [10]
  ...
  object dsEntradaPaciente: TDataSource [11]
    DataSet = qrEntradaPaciente
    Left = 104
    Top = 312
  end
  object qrEntradaPacienteDetalle: TADOQuery [12]
    Connection = DM.DataBase
    CursorType = ctStatic
    Parameters = <
      item
  ...
  object dsEntradaPacienteDetalle: TDataSource [13]
    DataSet = qrEntradaPacienteDetalle
    Left = 104
    Top = 360
  end
  object ppImpFactura: TppReport [14]
    AutoStop = False
  ...
  object ppImpCotizacion: TppReport [15]
    AutoStop = False
    DataPipeline = ppEntradaPacienteDetalle
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
