...
type
  TfrmDatosClientesDomicilio = class(TfrmCustomModule)
    ...
    qrClienteDomDetObservacion: TMemoField;
    qrClienteDomDetNumero_laboratorio: TStringField;
    qrClienteDomicilioComentario: TMemoField;
    ...
    qrReporteObservacion: TMemoField;
  ...
  inherited;
    ...
    begin
          If Trim(cxObservacion.Text) = EmptyStr then
             Raise exception.CreateFmt('Favor Digitar Observación.  Verifique.', [])
          else If Trim(dbExtUsuario.Text)=EmptyStr then
             Raise exception.CreateFmt('Favor Seleccionar Oficial Recibe Cancelación.  Verifique.', [])
    end;
end;
