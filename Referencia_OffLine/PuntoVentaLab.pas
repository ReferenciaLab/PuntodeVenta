...
type
  TfrmPuntoVentaLab = class(TfrmCustomModule)
    ...
    procedure GridPruebasEntradasPacienteDetComentarioPropertiesInitPopup(
      Sender: TObject);
    procedure CxDbPacienteKeyUp(Sender: TObject; var Key: Word;
      Shift: TShiftState);
  ...
  protected
    ...
    procedure CrearCobroAxapta(cliente: string; paciente: string; tipodoc: string;
                               ...
                               moneda:  string; aplica: string; _refId: Int64;
    ...
    procedure Printing_Label(_muestra: String; _label: String; _departamento: String;
                             ...
                             _descripcion2: String;_secuencia: Integer);
    ...
    procedure Insertar_Label_Temp(_paciente: String; _sucursal: String; _entrada: String;
                             ...
                             _medio: String; _label: String; _desc: String;
    ...
    Procedure Insertar_Usuario_New(usuario: string; clave: string; name: string;
                                   ...
                                   actual: string);
    procedure Borra_Lebels_Eliminados(Muestrano : String);
  private
    { Private declarations }
    strPacienteOrigen,strClienteNombre,strProyectoID,strClienteID,strGrupoDescTotal,strGrupoDescLinea,
    strGrupoPrecio,strFormaPago,strMonedaID,GrupoPrecio,GrupoCliente : String;
    strSinPrFilter  : integer;
  public
    { Public declarations }
    fecha_label          : TDateTime;
    TipoCob              : String;
    hora_label,titulo    : String;
    noseguro             : TcxStyle;
    Reportado            : TcxStyle;
    NReportado           : TcxStyle;
    Combo                : TcxStyle;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    function  Verifica_Labels(_muestra: String): Boolean;
    procedure Insertar_Pago_AS400_PuntodeVenta;
    procedure BuscarMateriales(registro : Integer);
    procedure InsertarDataLabels;
    Procedure Buscar_Labels_Temp(_Muestrano: String);
  end;
...
Var
  frmPuntoVentaLab   : TfrmPuntoVentaLab;
...
function TfrmPuntoVentaLab.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
 suc : Boolean;
...
procedure TfrmPuntoVentaLab.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
                                           tipoaplica: string; documentoaplica: string; fecha : TDateTime;
                                           valor: Double; moneda :string; paciente: string; filter: Integer);
Var
 qinsert : TADOQuery;
...
procedure TfrmPuntoVentaLab.CrearCobroAxapta(cliente: string; paciente: string; tipodoc: string;
                                          _cobroid: string; documento: string; fecha: TDateTime;
                                          moneda:  string; aplica: string; _refId: Int64;
                                          valor: Double; _areaId: string; _recId: Int64;
                                          _padreId: string; _cuadro: Integer; _transf: Integer;
...
procedure TfrmPuntoVentaLab.TransferirAxapta1Click(Sender: TObject);
Var
 qupdate : TADOquery;
begin
...
procedure TfrmPuntoVentaLab.CuadredeCaja1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.CuadredeCaja2Click(Sender: TObject);
begin
{
  inherited;
...
procedure TfrmPuntoVentaLab.cxDBCurrencyEdit4PropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.cxDBDateEdit5Exit(Sender: TObject);
begin
  inherited;
     if qrEntradaPaciente.State in [dsEdit, dsInsert] then
     Begin
      If (qrEntradaPacienteFechaNacimiento.Value > Date) Then
...
procedure TfrmPuntoVentaLab.cxDBDateEdit6Exit(Sender: TObject);
begin
  inherited;
     if qrEntradaPaciente.State in [dsEdit, dsInsert] then
     Begin
        If (qrEntradaPacienteFECHA_INDICACION.Value > DM.SystemDate) Then
          Raise exception.CreateFmt('La Fecha de Indicación es Incorrecta. Por Favor Verifique.!!!', []);
     End;
end;

procedure TfrmPuntoVentaLab.cxDBMemo2PropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.CxDbPacienteKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if Trim(cxDBPaciente.Text) <> EmptyStr then
     qrentradapacienteNombrePaciente.Value := cxDBPaciente.Text
end;

procedure TfrmPuntoVentaLab.cxDBTextEdit16KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.RegistrarPruebadelExterior1Click(Sender: TObject);
begin
  Val_Exterior;
end;


procedure TfrmPuntoVentaLab.CbDocumentoPropertiesChange(Sender: TObject);
begin
  Val_Exterior;
end;


procedure TfrmPuntoVentaLab.RefrescarGrid(SoloLectura: Boolean);
begin
...
procedure TfrmPuntoVentaLab.Impresiones;
begin
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaLab.ImpresionRecibo;
                  ...
                  begin
                      ...
                      Begin
                          ...
                          begin
                              ...
                              If (frmMain.frmTmpLab.qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoExt.Value) Or
                                 (frmMain.frmTmpLab.qrEntradaPacienteTipoDocumento.Value = 3) Or
...
procedure TfrmPuntoVentaLab.ImpresionNC;
Var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaLab.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.CancelarCobro;
begin
...
procedure TfrmPuntoVentaLab.CancelarOrdenInterfaseAS4001Click(Sender: TObject);
begin
  inherited;
  No_Procesar_AS400_Orden;
end;

function TfrmPuntoVentaLab.GetSecuenciaId : Int64;
Var
 _valor   : String;
 numero   : Int64;
 qsecdoc  : TADOQuery;
...
function TfrmPuntoVentaLab.GetMuestraNo : String;
Var
 _valor  : String;
 qsecdoc : TADOQuery;
 anio, mes, dia : Word;
...
function TfrmPuntoVentaLab.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;

function TfrmPuntoVentaLab.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;

function TfrmPuntoVentaLab.GetDevolucion : String;
begin
  result := GetNextSecDoc('DV');
end;

procedure TfrmPuntoVentaLab.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaLab.Val_Exterior_Detalle;
begin
 If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoExt.Value) Or
    (qrEntradaPacienteTipoDocumento.Value = 3) Or
...
function TfrmPuntoVentaLab.ImporteBrutoExclLineaActual(refrecid : int64 ; secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLab.ImporteBrutoExclLineaActualAplica(refrecid : int64 ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLab.ImporteBrutoExclLineaActualAplicaAndCobertura(refrecid : int64 ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLab.TotalDescuentoLinea : Double;
Var
...
function TfrmPuntoVentaLab.ImporteLinea : Double;
Var
...
function TfrmPuntoVentaLab.CalcularCoberturaAplicada : Double;
var
...
function TfrmPuntoVentaLab.Valor_Cobertura(_registro : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.CodigodeBarra1Click(Sender: TObject);
Var
  Tipo : String;
begin
  inherited;
  ...
  begin
     ...
     NuevaVenta;
     if (CxDbPaciente.Enabled) and (CxDbPaciente.Visible) then cxdbPaciente.SetFocus;
  end;
end;


procedure TfrmPuntoVentaLab.BtInterfaseAS400Click(Sender: TObject);
begin
  ...
  begin
      EtMensajeDlg('Las Entradas Generadas por As400 NO pueden ser transferidas al AS-400.  Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true)
  end;
end;


procedure TfrmPuntoVentaLab.RegistrarCobrosTemporales1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.RegistrarFechaPrometida1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.RegistrarNuevoPaciente1Click(Sender: TObject);
Var
 sqlString   : String;
...
procedure TfrmPuntoVentaLab.ConfirmarCobertura1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.btcancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.btclienteClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.btentradaClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
procedure TfrmPuntoVentaLab.btgrabarClick(Sender: TObject);
Var
 Tipo,stHold,Muestrano,sqlString,TipoDoc,EntradaId,Id_Visita,Cod_Prueba : String;
 intEdad_Pac                : integer;
 from_hold                  : Boolean;
...
begin
 ...
 begin
    EtMensajeDlg('Fecha de la Aplicación y Fecha del Servidor No coinciden.  Favor salir de la aplicación y vuelva a entrar.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
    exit;
 end;
  If (Trim(qrEntradaPacienteEntradaID.Value) = EmptyStr) And (qrEntradaPacienteOrigen.Value = dm.qrParametroGrupoPriv.Value)
  And (qrEntradaPacienteNO_INDICACION.VALUE = False) then
 begin
      if DM.Mensaje('La No indicación médica (Marca X) en blanco.  Desea marcar La No Indicación ?',mb_yesno) = id_yes then
      begin
          exit;
      end;
 end;
 ...
 And ((qrEntradaPacienteOrigen.Value = dm.qrParametroGrupoPriv.Value) Or (qfindcltParams.FieldByname('No_Indicacion').AsBoolean=True))
 And (qrEntradaPacienteNO_INDICACION.Value = False) then
 begin
      if DM.Mensaje('La No indicación médica (Marca X) en blanco.  Desea marcar La No Indicación ?',mb_yesno) = id_yes then
      begin
 ...
 begin
          ...
          begin
		        Raise exception.CreateFmt('Debe colocarle P de inicio al número de Autorización. Verifique.', []);
          end;
          ...
          begin
		        Raise exception.CreateFmt('Debe colocarle H de inicio al número de Autorización. Verifique.', []);
          end;
 end;

 If (Trim(qrEntradaPacientePolizaID.Value) = EmptyStr) And (qrEntradaPacienteOrigen.Value = dm.qrParametroGrupoSeg.Value) Then
 begin
      Raise exception.CreateFmt('Número Afiliado/Contrato No pueden estar en blanco. Por Favor Verifique.!!!', []);
 end;

 If (Trim(qrEntradaPacienteAprobacionNo.Value) = EmptyStr) And (qrEntradaPacienteOrigen.Value = dm.qrParametroGrupoSeg.Value) Then
 begin
      if DM.Mensaje('Número de Aprobación en blanco.  Desea digitar Número de Aprobación ?',mb_yesno) = id_yes then
      begin
          exit;
      end;
 end;

 If (Trim(qrEntradaPacienteAprobacionPor.Value) = EmptyStr) And (qrEntradaPacienteOrigen.Value = dm.qrParametroGrupoSeg.Value) Then
 begin
      if DM.Mensaje('Aprobación Por está en blanco.  Desea digitar Aprobación Por ?',mb_yesno) = id_yes then
      begin
          exit;
      end;
 end;
 ...
 begin
       ...
       Begin
           ...
           begin
              EtMensajeDlg('Orden Selección Pruebas de Paternidad NO CORRECTO.  Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
              Exit;
           end;
     ...
     begin
           ...
           begin
              ...
              begin
                ...
                begin
                  Raise exception.CreateFmt(' USA CARGO ADICIONAL NO correcto. Favor verifique número de pruebas USA.', []);
                end
              end
              else
              begin
...
//   Sie es Nuevo o está en Hold entonces entra
...
//        Mirar_Valor_CAB;
     ...
     //Generando las Acciones del Boton COBRAR Original.
      If ((chkCobro.Checked) And (Act_2da = False)) Or
          (DM.Chequea_Combo(qrEntradaPacienteRecID.Value)) then
      begin
         If (qrEntradaPacienteFormaDePago.Value = 'CRE') And (qrEntradaPacienteOrigen.Value <> DM.qrParametroGrupoSeg.Value) Then
         begin
              if DM.Mensaje('Factura a Crédito.  Desea realizar el pago ?',mb_yesno) = id_yes then
              begin
         ...
         begin
               ...
               begin
                 CancelarCobroAct;
                 TipoCob:=EmptyStr;
                 Raise exception.CreateFmt( ' NO Se Pudo Generar la Nota de Crédito. '+ #13 +
                                            ' Se Ha Generado Un Error. '+ #13 +
                                            ' Por Favor, Intentelo Nuevamente.!!!', []);
               end;
         end
         ...
         begin
               ...
               begin
                 CancelarCobroAct;
                 TipoCob:=EmptyStr;
                 Raise exception.CreateFmt( ' NO Se Pudo Generar la Nota de Débito. '+ #13 +
                                            ' Se Ha Generado Un Error. '+ #13 +
                                            ' Por Favor, Intentelo Nuevamente.!!!', []);
               end;
         end
         ...
         begin
               ...
               begin
                 CancelarCobroAct;
                 TipoCob:=EmptyStr;
                 Raise exception.CreateFmt( ' NO Se Pudo Generar la Devolución. '+ #13 +
                                            ' Se Ha Generado Un Error. '+ #13 +
                                            ' Por Favor, Intentelo Nuevamente.!!!', []);
               end;
         end;
...
{    If (qrEntradapacienteTotalPendiente.AsFloat > 0) Then
    ...
    If (imprimirNC) and (cobroid <> '') and ((TipoCobro = 'NC') or (TipoCobro = 'DV')) then
       ImpresionNC;
    ...
    Begin
               ...
               If Not Buscar_User_Internet(qrEntradaPacientePacienteId.Value) Then
                 ...
                 Else
                   if qrEntradaPacientePublicarInternet.Value = 1 then
                      EtMensajeDlg('Número de cédula no válido.  No podrá generar clave de internet.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
             end;
             end;
        ...
        Begin
          ...
          sleep(3000) ; // or some other work
          If qfindSucursal.FieldByName('StImpLabelLab').AsString = 'S' Then ImprimirLabels_sp(Muestrano);
        End;
       end;
       if (qrEntradaPacienteOrigen.value = dm.qrParametroGrupoLab.Value) or
          (qrEntradaPacienteOrigen.value = dm.qrParametroGrupoProy.Value) or
          (qrEntradaPacienteOrigen.value = dm.qrParametroGrupoOtro.Value) or
          (qrEntradaPacienteOrigen.value = dm.qrParametroGrupoCia.Value) then
       begin
          strPacienteOrigen := qrEntradaPacienteOrigen.Value;
          strClienteNombre  := qrEntradaPacienteClienteNombre.Value ;
          strProyectoID     := qrEntradaPacienteProyectoID.value ;
          strClienteID      := qrEntradaPacienteClienteID.Value ;
          strSinprFilter    := qrEntradaPacienteSINPRFILTER.value ;
          strGrupoDesctotal := qrEntradaPacienteGrupoDescuentoTotal.value;
          strGrupoDescLinea := qrEntradaPacienteGRUPODESCUENTOTOTAL.value ;
          strGrupoPrecio    := qrEntradaPacienteGRUPOPRECIO.value ;
          strFormaPago      := qrEntradaPacienteFORMADEPAGO.Value;
          strMonedaID       := qrEntradaPacienteMonedaID.Value;
       end;
      NuevaVenta;
//      HabilitaConsultas;
     if (CxDbPaciente.Enabled) and (CxDbPaciente.Visible) then cxdbPaciente.SetFocus;
...
procedure TfrmPuntoVentaLab.BtHoldClick(Sender: TObject);
begin
 inherited;
...
procedure TfrmPuntoVentaLab.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntradaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaLab.btnotacreditoClick(Sender: TObject);
begin
  inherited;
...
begin
  inherited;
  if Not dm.Verifica_MonedaCliente(EdCliente.Text,cxDBTextEdit14.Text) Then
  begin
        EtMensajeDlg('Moneda para este cliente no es válido.  Favor seleccione el Cliente.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
        Exit;
  end;
  If Trim(qrEntradaPacienteNombrePaciente.value)=Emptystr then
  begin
      Raise exception.CreateFmt(' Nombre del Paciente en blanco.  Por Favor Verifique.!!!', []);
  end;
  If Trim(qrEntradaPacienteCLIENTENOMBRE.value)=Emptystr then
  begin
      Raise exception.CreateFmt(' Cliente en blanco.  Por Favor Verifique.!!!', []);
  end;
...
procedure TfrmPuntoVentaLab.FormActivate(Sender: TObject);
begin
  inherited;
  Factura_St := 'L';
end;

procedure TfrmPuntoVentaLab.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.FormCreate(Sender: TObject);
begin
  inherited;
  ...
  qfindSucursal := DM.Find_Ldr('SELECT Cliente_Uno, Cliente_Dos, Sucursal, Impresiones, GrupoID, stImpLabelLab FROM PTSucursal (nolock) WHERE SucursalId = :suc', DM.CurSucursal);
...
procedure TfrmPuntoVentaLab.FormDestroy(Sender: TObject);
begin
  lcGeneral.LookAndFeel.GroupOptions.Color := $00F8E3D1;
...
procedure TfrmPuntoVentaLab.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaLab.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaLab.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaLab.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaLab.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.NuevaVenta;
Var qact : TADOQuery;
begin
    qact := DM.NewQuery;
    With  qact, sql do
  ...
  //  _recorId := DM.Get_Secuencia('Secuencia');
    ...
    Else
      if Trim(qrEntradaPacienteClienteID.Value) <> EmptyStr then qrEntradaPacienteClienteID.Value := '';

    if strPacienteOrigen = EmptyStr then
      qrEntradaPacienteOrigen.Value       := DM.qrParametroGrupoLab.Value
    else
      qrEntradaPacienteOrigen.Value       := strPacienteOrigen;
    qrEntradaPacienteClienteNombre.Value  := strClienteNombre;
    qrEntradaPacienteDIRECCION.Value      := 'LABORATORIOS';
    qrEntradaPacienteProyectoID.value     := strProyectoID;
    if (qrEntradaPacienteClienteID.Value <> strClienteID)  then
      qrEntradaPacienteClienteID.Value    := strClienteID;
    qrEntradaPacienteSINPRFILTER.value    := strSinprFilter;
    qrEntradaPacienteGrupoDescuentoTotal.value := strGrupoDesctotal;
    qrEntradaPacienteGRUPODESCUENTOTOTAL.value := strGrupoDescLinea;
    qrEntradaPacienteGRUPOPRECIO.value    := strGrupoPrecio;
    Buscar_Cliente;
    qrEntradaPacientePacienteID.Value     := CodPacienteLab;
    qrEntradaPacienteSexo.Value           := 2;
    qrEntradaPacienteNombrePaciente.value := '';
    qrEntradaPacientePolizaid.value       := CodPolizaPacLab;

    qrEntradaPacienteDoctorId.value       := inttostr(CodDoctorLab);
    ...
    if strMonedaID <> EmptyStr then
      qrEntradaPacienteMonedaID.Value         := strMonedaID
    else
    ...
    qrEntradaPacienteClientePadre.Value       := EmptyStr;
    ...
    cxdbdateedit5.Clear;
    qrEntradaPacienteFormadePago.Value        := strFormaPago;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteAfterPost(DataSet: TDataSet);
Var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteClienteIDChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaLab.qrEntradaPacientePACIENTEIDValidate(Sender: TField);
begin
  inherited;
  Val_Paciente;
end;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
  qrEntradaPaciente.Edit;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Val_Descuento;
//  VerificarPagoDiferencia;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleAfterPost(DataSet: TDataSet);
begin
  inherited;
  if qrEntradaPaciente.State in [dsEdit, dsInsert] then
    Begin
...
procedure TfrmPuntoVentaLab.BalanceActual1Click(Sender: TObject);
begin
  inherited;
  If (qrEntradaPacientePacienteId.Value <> '') Or
...
procedure TfrmPuntoVentaLab.VerTransacciones1Click(Sender: TObject);
begin
  inherited;
  If (qrEntradaPacientePacienteId.Value <> '') Or
  Not(qrEntradaPacientePacienteId.IsNull) Then
...
procedure TfrmPuntoVentaLab.Val_Exterior;
begin
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVentaLab.Val_Paciente;
begin
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaLab.Val_Forma_Pago(Forma_Pago: string);
begin
...
procedure TfrmPuntoVentaLab.Leer_Forma_Pago;
begin
...
procedure TfrmPuntoVentaLab.Val_Balance;
begin
      if not((qrEntradaPacientePacienteId.Value ='00029127') or (qrEntradaPacientePacienteId.Value ='00008805') or
         (qrEntradaPacientePacienteId.Value ='00018822') or (qrEntradaPacientePacienteId.Value ='00029448') or
         (qrEntradaPacientePacienteId.Value ='00006242')) then
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleBeforeDelete(DataSet: TDataSet);
begin
  inherited;
  //Pruebas de los Seguros.
  curCoberturaAplicada := DM.CurCoberturaAplicada(qrEntradaPacienteRECID.Value); //DM.CurCoberturaAplicada(_recorId)
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
  comboborrar := False;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
  comboborrar := False;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
 inherited;
 If qrEntradaPacienteDetalle.State in [dsEdit, dsInsert] then
  Begin
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleCalcFields(
  DataSet: TDataSet);
begin
  inherited;
{  If qrEntradaPacienteEntradaID.Value <> EmptyStr then
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetalleDescuentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
Var
 valor_precio : Double;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
  Begin
    qrEntradaPacienteDetalle.Edit;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteDoctorIDChange(Sender: TField);
begin
  inherited;
//  Buscar_Doctor;
end;

procedure TfrmPuntoVentaLab.EdDoctorDblClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7984);
end;

procedure TfrmPuntoVentaLab.EdDoctorPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor;
end;

procedure TfrmPuntoVentaLab.EdNombreDoctorDblClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7984);
end;

procedure TfrmPuntoVentaLab.Buscar_Doctor;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaLab.Buscar_Doctor_Cambio;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteNombrePacienteValidate(Sender: TField);
begin
  inherited;
  If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value) Or
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
 inherited;
...
procedure TfrmPuntoVentaLab.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.Materiales1Click(Sender: TObject);
begin
  inherited;
...
function TfrmPuntoVentaLab.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLab.Buscar_Linea: Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.MenuItem1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.ActTotales;
Var
 qfind : TADOQuery;
begin
 If (qrEntradaPacienteDetalle.RecordCount > 0) Then
...
procedure TfrmPuntoVentaLab.AsignarDescuentoAutorizadoporCobros1Click(
  Sender: TObject);
begin
...
procedure TfrmPuntoVentaLab.AsignarDescuentoPermitidoalUsuario1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.RecalcularLineas;
begin
 qrEntradaPacienteDetalle.DisableControls;
 qrEntradaPacienteDetalle.First;
...
procedure TfrmPuntoVentaLab.RecibodeCobro1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.EliminarDescuentoAplicado1Click(Sender: TObject);
begin
  inherited;
  qrEntradaPaciente.Edit;
  qrEntradaPacienteDescuentoPorc.Value := 0;
...
procedure TfrmPuntoVentaLab.EliminarOrdenesenHold1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.MarcarPruebaNOProcesar1Click(Sender: TObject);
begin
  inherited;
  No_Procesar;
end;
...
function TfrmPuntoVentaLab.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLab.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmPuntoVentaLab.Devolucin1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991, qrEntradaPacienteRECID.asstring,'DV');
end;

procedure TfrmPuntoVentaLab.DistribucionCobrado1Click(Sender: TObject);
begin
  inherited;
      frmMain.LanzaConsulta(-7992, dm.CurUser,formatdatetime('yyyymmdd',DM.Buscar_Fecha_Actual));
end;

procedure TfrmPuntoVentaLab.dsEntradaPacienteStateChange(Sender: TObject);
var ds: string;
begin
  inherited;
...
procedure TfrmPuntoVentaLab.EdCoberturaValorExit(Sender: TObject);
begin
  inherited;
  Act_Cobertura
end;
...
procedure TfrmPuntoVentaLab.Act_Cobertura;
begin
 if qrEntradaPaciente.State in [dsedit, dsinsert] then
  begin
    qrEntradaPacienteDescuentoValor.Value := 0;
...
function TfrmPuntoVentaLab.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.GastosVarios1Click(Sender: TObject);
begin
  inherited;
...
function TfrmPuntoVentaLab.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
function TfrmPuntoVentaLab.GetEntradaID_Hold : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
procedure TfrmPuntoVentaLab.Boton_Cobrar;
begin
...
procedure TfrmPuntoVentaLab.Viejo_Cobrar;
begin
  inherited;
...
procedure TfrmPuntoVentaLab.CrearCobro;
Var
 qinsert    : TADOQuery;
...
{
procedure TfrmPuntoVentaLab.RefrescarCobro;
Var
 qfind : TADOQuery;
begin
  DM.qrParametro.Close;
 ...
 //Cargando las Formas de Pago en Peso.
 If (qrEntradaPacienteTipoDocumento.Value <> 3) And
    (QrEntradaPacienteFactExterior.Value = 0) And
    (qrEntradaPacienteMonedaID.Value <> DM.qrParametroMonedaDolares.Value) Then
   Begin
     qfind := DM.NewQuery;
     ...
     begin
        Close;
        Text := ' SELECT * FROM PTCobroDetalle D, PTFormaDePago f '+
                       ' WHERE D.cobroid = '+ #39 + cobroID + #39 +
                       ' AND D.refRecId = '+ #39 + qrEntradaPacienteRECID.AsString + #39 +
                       ' AND D.FormaDePagoId = f.FormaDePagoID '+
                       ' AND f.FormaDePagoId = '+ #39 +CodEfectivo+ #39 +
                       ' AND f.DataAreaId = ' + #39 + DM.CurEmpresa + #39 +
                       ' ORDER BY D.orden';
        Open;
        if IsEmpty then DM.Error('Error Cargando Formas de Pago en RD$.  Verifique.');
     end;
   ...
   Begin
     ...
     begin
        ...
        Text := ' SELECT * FROM PTCobroDetalle D, PTFormaDePago f '+
                       ...
                       ' ORDER BY D.orden';
        Open;
        if IsEmpty then DM.Error('Error Cargando Formas de Pago en US$.  Verifique.');
     end;
   end;
...
procedure TfrmPuntoVentaLab.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
Function TfrmPuntoVentaLab.buscar_valores;
Var
  valor : Boolean;
begin
  valor := True;
...
procedure TfrmPuntoVentaLab.correccion;
begin
  mdPago.First;
  While Not mdPago.Eof do
   Begin
...
function TfrmPuntoVentaLab.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmPuntoVentaLab.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
// cobroid := IntToStr(DM.Get_Secuencia('Secuencia'));
...
procedure TfrmPuntoVentaLab.ActNotaCredito;
Var
 qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
...
procedure TfrmPuntoVentaLab.ActDevolucion;
Var
 qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
 ...
 if (qfindcobro.RecordCount > 0) then
   Begin
     ...
     CrearCobroAxapta(qrEntradaPacienteCLIENTEID.Value, qrEntradaPacientePACIENTEID.Value, 'DV', cobroid,
                      ...
                      qrEntradaPacienteMonedaId.Value, qrEntradaPacienteEntradaID.Value,
                      qrEntradaPacienteRECID.Value, ValorNC, qrEntradaPacienteDATAAREAID.Value, GetSecuenciaId, //StrtoInt(cobroid),
                      qrEntradaPacienteCLIENTEPADRE.Value, 0, 0, DM.CurSucursal, 'DV',
                      ValorNC, qrEntradaPacienteSINPRFILTER.Value);
...
procedure TfrmPuntoVentaLab.CrearNotaDebito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVentaLab.ActNotaDebito;
Var
qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
...
procedure TfrmPuntoVentaLab.VolantedePruebasARS1Click(Sender: TObject);
begin
  inherited;
//  Application.ProcessMessages;
    Buscar_Cliente;
...
procedure TfrmPuntoVentaLab.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
//  Application.ProcessMessages;
  if Trim(qrEntradaPacienteEntradaID.Value) <> EmptyStr then
...
procedure TfrmPuntoVentaLab.vwDoctoresKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.FacturaExterior1Click(Sender: TObject);
begin
//  Application.ProcessMessages;
...
procedure TfrmPuntoVentaLab.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := _recorId;
  qrEntradaPaciente.Open;
...
procedure TfrmPuntoVentaLab.ActInterface;
begin
     DM.qrParametro.close;
     DM.qrParametro.open;
...
procedure TfrmPuntoVentaLab.RefrescarInterface;
begin
// actinterface;
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
//    btnotacredito.Enabled := true;
 ...
 begin
   ...
   if (Trim(qrEntradaPacienteEntradaID.Value) <> EmptyStr) and  (Copy(Trim(qrEntradaPacienteEntradaID.Value),1,3) <> 'HOL')
      And (DM.CurRolActLaboratorio = False) Then
   begin
...
procedure TfrmPuntoVentaLab.Val_Descuento;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
 Buscar_Cliente;
...
procedure TfrmPuntoVentaLab.VerificarPagoDiferencia;
Var
 qfind : TADOQuery;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
...
function TfrmPuntoVentaLab.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
function TfrmPuntoVentaLab.CanMenuEspecial;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLab.Asignar_Descuento;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaLab.Act_Hold;
var
 qfind : TADOQuery;
begin
{
...
//Eliminando Los Documentos en Hold.
procedure TfrmPuntoVentaLab.Del_Hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.DepositosSucursales1Click(Sender: TObject);
begin
...
procedure TfrmPuntoVentaLab.No_Procesar;
Var
 qact : TADOQuery;
begin
{
...
procedure TfrmPuntoVentaLab.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.Buscar_Muestra;
Var
 Dias   : Extended;
 qfind  : TADOQuery;
begin
...
//Validando Los Datos de la 2da. Muestra.
procedure TfrmPuntoVentaLab.Val_2da_Muestra;
Var
 qfind  : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.Buscar_Combo;
begin
...
procedure TfrmPuntoVentaLab.Borrar_Combo;
begin
...
procedure TfrmPuntoVentaLab.Actu_Precio_Combo;
Var
  valor : Double;
  qfind : TAdoQuery;
Begin
...
procedure TfrmPuntoVentaLab.Insertar_Combo_Precio;
begin
...
procedure TfrmPuntoVentaLab.Insertar_Combo_Blanco;
begin
 While Not qfindcombo.Eof Do
  Begin
   If (qrEntradaPacienteDetallePruebaID.Value = '') Or
...
procedure TfrmPuntoVentaLab.Act_Cliente;
Var
  texto       : String;
...
//Buscando los Datos del Cliente a Facturar y Sus Parametros.
procedure TfrmPuntoVentaLab.Buscar_Cliente;
begin
// If (qrEntradaPacienteClienteId.Value <> '') then
//  Begin
...
//Buscando los Datos del PACIENTE Registrado y Sus Parametros.
procedure TfrmPuntoVentaLab.Buscar_Paciente;
begin
...
//Buscando los Datos del Grupo del Cliente.
Procedure TfrmPuntoVentaLab.Buscar_Grupo_Clt(Grupo: string);
begin
...
//Buscando los Datos del Grupo del Paciente.
Procedure TfrmPuntoVentaLab.Buscar_Grupo_Pac(Grupo: string);
begin
...
procedure TfrmPuntoVentaLab.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
//Insertando Los Datos de la Tarjeta de Descuento.
procedure TfrmPuntoVentaLab.Insert_Card_Descuento;
...
procedure TfrmPuntoVentaLab.InstructivodeInternet1Click(Sender: TObject);
...
begin
  inherited;
         ...
         begin
            ...
            begin
              ...
              begin
                  ...
                  begin
                    Raise exception.CreateFmt('Cédula del paciente '+qPacientet.FieldByName('identificacion').AsString+' es inválida .  Favor Verifique.', []);
        ...
        begin
            Raise exception.CreateFmt('Número de cédula no válido.  No podrá generar clave de internet.',[]);
            exit;
        end
        end
        else
...
procedure TfrmPuntoVentaLab.CabeFactSeguroBeforePrint(Sender: TObject);
begin
{
...
procedure TfrmPuntoVentaLab.ppHeaderBand4BeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaLab.ppHeaderBand5BeforePrint(Sender: TObject);
Var Texto1, Texto2 : String;
begin
 Texto1 := '';
 Texto2 := '';
...
procedure TfrmPuntoVentaLab.ppHeaderBand6BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaLab.ppImpFactPacienteSinSeguroBeforePrint(
  Sender: TObject);
begin
  inherited;
  Buscar_Cliente;
  ...
  case qfindCltParams.FieldByName('GrupoCliente').AsInteger of
     1,2,3,4,5,8,10,12  :Begin
            pplabel180.Caption:='FACTURA PACIENTE';
        End;
     7  :Begin
            pplabel180.Caption:='FACTURA LAB. CLIENTES';
         End;
     9  :Begin
            pplabel180.Caption:='FACTURA PRE-EMPLEO';
         End;
  end;
...
procedure TfrmPuntoVentaLab.ppImpInternetBeforePrint(Sender: TObject);
Var I : Integer;
    qSerial : TADOQuery;
begin
  qSerial := DM.NewQuery;
  ...
  begin
      ppRichText8.RichText:='Aprobado por: '+qSerial.FieldByName('Aprobado').AsString+'                 Serial: '+qSerial.FieldByName('Serial').AsString+chr(10)+
                            'Fecha de Emisión: '+FormatDateTime('dd/mm/yy',qSerial.FieldByName('Fecha_Emision').Value)+'    Fecha de Revisión: '+FormatDateTime('dd/mm/yy',qSerial.FieldByName('Fecha_Revision').Value);
  end;
  FreeAndNil(qSerial);  
end;

procedure TfrmPuntoVentaLab.ppSummaryFacturaSeguroBeforePrint(Sender: TObject);
Var I : Integer;
    qSerial : TADOQuery;
begin
  ...
  begin
      ppRichText1.RichText:='Por este medio autorizo  al Laboratorio, a suministrar toda '+
                            'información que sea solicitada por ARS Palic Salud, S.A., '+
...
procedure TfrmPuntoVentaLab.ppSummaryBand4BeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaLab.ppSummaryFactPacienteConSeguroBeforePrint(Sender: TObject);
Var qSerial : TADOQuery;
begin
  inherited;
  Buscar_Cliente;
...
procedure TfrmPuntoVentaLab.ppSummaryFactPacienteSinSeguroBeforePrint(Sender: TObject);
Var qSerial : TADOQuery;
begin
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVentaLab.ppDetailBand3BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaLab.ppDetailBand4BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaLab.ppDetailBandSinSeguroBeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaLab.ppDetailBandConSeguroBeforePrint(Sender: TObject);
begin
  qfindPrueba := DM.Find_Ldr('SELECT * FROM PtPrueba (nolock) WHERE PruebaID = :pru', qrEntradaPacienteDetallePruebaId.Value);
  If qfindPrueba.FieldByName('Font_Bold').Value = True Then
...
procedure TfrmPuntoVentaLab.Insertar_Materiales_Prueba;
Var
...
procedure TfrmPuntoVentaLab.Insertar_Materiales_Envase;
Var
 qfind, qinsert : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.Insertar_Materiales_Sangre;
Var
 qfind, qinsert : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLab.BuscarDia(dia: Integer) : Integer;
Var
 valor : Integer;
begin
 valor := 0;
...
function TfrmPuntoVentaLab.FechaPrometida(Prueba: string) : TDate;
Var
 fecha : TDate;
 qtest : TADOQuery;
 qfrec : TADOQuery;
...
procedure TfrmPuntoVentaLab.Insertar_LabelTemp;
Var
 Valor      : String;
 Qinsert    : TADOQuery;
begin
...
function TfrmPuntoVentaLab.Validar_Label_Temp(_paciente: String; _entrada: String;
                                           _muestra: String; _prueba: String): Boolean;
Var
 qfind : TADOQuery;
 valor : Boolean;
...
procedure TfrmPuntoVentaLab.Crear_Labels_Temp(_Muestrano: String);
Var
 qbuscar  : TADOQuery;
begin
 _total_sangre  := 0;
 ...
 qbuscar.SQL.Text := ' SELECT   pacienteid, sucursal, Entradaid, MuestraNo, TipoMuestra, '+
                     '          DeptId, Medio, '+
                     ' COUNT(MuestraNo) As Total FROM PTLabelTemp (nolock) '+
                     ' WHERE    Muestrano = '+#39+_Muestrano+#39+
                     ' GROUP BY pacienteid, sucursal, Entradaid, MuestraNo, '+
                     '          TipoMuestra, DeptId, Medio '+
                     ' ORDER BY TipoMuestra, DeptId, Medio ';
 qbuscar.Open;
     ...
     While Not qbuscar.Eof Do
      Begin
        ...
        Buscar_Label_Temp(qbuscar.FieldByName('PacienteId').AsString, qbuscar.FieldByName('Sucursal').AsString,
                          ...
                          qbuscar.FieldByName('Medio').AsString, qbuscar.FieldByName('Total').AsInteger);
...
procedure TfrmPuntoVentaLab.Buscar_Label_Temp(_paciente: String; _sucursal: String; _entrada: String;
                                           _muestra: String; TipoMuestra: String; _departamento: String;
                                           _medio: String; _total: Integer);
Var
 qdata  : TADOQuery;
...
//Insertando la Prueba Registrada en la Tabla Temporal
procedure TfrmPuntoVentaLab.Update_Label_Temp(_paciente: String; _entrada: String; _muestra: String;
                                           _prueba: String; _label: String; _labelglobal: String;
                                           _labelunico: String; _desc: String; _recid: Int64;
                                           _secuencia: Integer; _numero: Integer);
Var
...
procedure TfrmPuntoVentaLab.Update_Label_Descripcion(_label: String; _descripcion: String);
Var
 qactu    : TADOQuery;
begin
  qactu := DM.NewQuery;
...
//Generando los Labels de la Toma de Muestra.
procedure TfrmPuntoVentaLab.Generar_Labels;
Begin
  Insertar_LabelTemp;
  Crear_Labels_Temp(qrEntradaPacienteDetalleMuestrano.Value);
...
procedure TfrmPuntoVentaLab.Postear;
begin
// If ( qrEntradaPacienteDetalle.RecordCount > 0) Then
 If ( qrEntradaPacienteDetalle.State in [dsEdit,dsInsert] ) Then
   Begin
...
procedure TfrmPuntoVentaLab.InsertarDataLabels;
Begin
  qrEntradaPacienteDetalle.Edit;
 ...
 Buscar_Labels_Temp(qrEntradaPacienteDetalleMuestrano.Value);
End;
Procedure TfrmPuntoVentaLab.Buscar_Labels_Temp(_Muestrano: String);
begin
 qfindLabel := DM.NewQuery;

 qfindLabel.Close;
 qfindLabel.SQL.Text := ' SELECT pacienteid, sucursal, Entradaid, MuestraNo, TipoMuestra, DeptId, Medio, '+
                        '        Label, DescripcionLabel, Secuencia, RecId, COUNT(label) As Total FROM PTLabelTemp (nolock) '+
                        ' WHERE Muestrano = :mue '+
                        ' GROUP BY pacienteid, sucursal, Entradaid, MuestraNo, TipoMuestra, DeptId, '+
                        '          Medio, Label, DescripcionLabel, Secuencia, RecId '+
                        ' ORDER BY secuencia ';

 qfindLabel.Parameters.ParamByName('mue').Value := _Muestrano;
 qfindLabel.Open;
 ...
 If (qfindLabel.RecordCount > 0) Then
   Begin
     ...
     While Not qfindLabel.Eof Do
         ...
         If Not Buscar_Labels(qfindLabel.FieldByName('MuestraNo').Value,
           ...
           Begin
             Insertar_Label_Temp(qfindLabel.FieldByName('PacienteId').AsString, qfindLabel.FieldByName('Sucursal').AsString,
                                 ...
                                 qfindLabel.FieldByName('Medio').AsString, qfindLabel.FieldByName('Label').AsString, qfindLabel.FieldByName('DescripcionLabel').AsString,
       ...
       End;
   End;
FreeAndNil(qfindLabel);
end;
procedure TfrmPuntoVentaLab.Insertar_Label_Temp(_paciente: String; _sucursal: String; _entrada: String;
                                               _muestra: String; TipoMuestra: String; _departamento: String;
                                               _medio: String; _label: String; _desc: String;
                                               _secuencia: Integer; _recid: Int64);
Var
...
function TfrmPuntoVentaLab.Buscar_Labels(_muestra: String; _label: String): Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
 ...
 qfind.Close;
 qfind.SQL.Text := ' SELECT * FROM PTLabel (nolock) '+
                   ' WHERE MuestraNo = :num '+
                   ' AND Label = :lab ';
...
procedure TfrmPuntoVentaLab.BuscarMateriales(registro : Integer);
begin
...
procedure TfrmPuntoVentaLab.ImprimirLabels(_Muestrano : String);
Var
 qprint   : TADOQuery;
 printer  : String;
begin
  ...
  qprint  := DM.NewQuery;
  qprint.Close;
  qprint.SQL.Text := ' SELECT a.Muestrano,a.Label,a.Descripcion,a.Secuencia, b.NAME AS DescDept, c.NombrePaciente as Nombre From '+
                     ' PTLabel a (nolock), ldrDepartments b (nolock), PTEntradaPaciente c (nolock)'+
                     ' WHERE a.MuestraNo = '+ #39 + _Muestrano+ #39 +
                     ' AND a.Deptid = b.LDRDEPARTAMENTOID AND a.muestrano = c.muestrano '+
                     ' and b.dataareaid='+#39+'ldr'+#39+' and c.dataareaid='+#39+'ldr'+#39+
     ...
     While Not qprint.Eof Do
       Begin
         Printing_Label(qprint.FieldByName('MuestraNo').AsString,
                        ...
                        qprint.FieldByName('Nombre').AsString, DM.CurUser,
                        qprint.FieldByName('Descripcion').AsString,
                        qprint.FieldByName('Descripcion2').AsString,
...
procedure TfrmPuntoVentaLab.ImprimirLabels_sp(_Muestrano : String);
Var
 qprint   : TADOQuery;
 printer  : String;
begin
  ...
  if dm.PingHost(dm.qrParametroServidor_AS400.value,1) then
  begin
//        Showmessage('Param AS='+dm.qrParametroServidor_AS400.value);
 //         Application.ProcessMessages();
          qprint.Close;
          qprint.SQL.Text := ' SELECT Convert(Varchar(11),LA10NU)+LAALF2 AS Muestrano,'+
                             ...
                             '  LA10SE As Secuencia                                                                      '+
                             '                 FROM [DBFIN].[S10D7471].[LALIB].[LAP01001] L INNER JOIN PTPRUEBA P ON L.LA10C1=CONVERT(INT,P.CODIGOIDAS400) '+
...
procedure TfrmPuntoVentaLab.Printing_Label(_muestra: String; _label: String; _departamento: String;
...
//   Showmessage('Printt AS='+Ruta_BarCode);
   BeginDoc;
     writeLn('FK"FORMA"');
     writeLn('FS"FORMA"');
     writeLn('');
...
procedure TfrmPuntoVentaLab.RefrescarData;
Var
  Bm : TBookMark;
begin
  Bm := qrEntradaPacienteDetalle.GetBookmark;
...
procedure TfrmPuntoVentaLab.Act_Fecha;
var
 qactu : TADOQuery;
begin
  qactu  := DM.NewQuery;
  ...
  While Not qrEntradaPacienteDetalle.Eof Do
   Begin
        qactu.Close;
        qactu.SQL.Text := ' UPDATE PtentradaPacienteDetalle With (rowlock) '+
                          ' SET FlebotomistaId = :Fle, '+
                          ' FechaEntrega = :Fe, '+
                          ' HoraEntrega =  :He '+
                          ' WHERE Muestrano = :lab And Recid = :Recid ';
        qactu.Parameters.ParamByName('Fle').Value   := DM.CurUser;
        qactu.Parameters.ParamByName('Fe').Value    := FechaPrometida(qrEntradaPacienteDetallePruebaId.Value);
        qactu.Parameters.ParamByName('He').Value    := Copy(DM.Buscar_Hora_Actual, 1, 20);
        qactu.Parameters.ParamByName('Lab').Value   := qrEntradaPacienteDetalleMuestrano.Value;
        qactu.Parameters.ParamByName('Recid').Value := qrEntradaPacienteDetalleRecid.Value;
        qactu.ExecSQL;
...
function TfrmPuntoVentaLab.ExistenPruebasProcesar : Boolean;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
 qfind.Close;
 qfind.SQL.Text := ' SELECT TOP 1 * FROM PTEntradaPacienteDetalle (nolock) '+
...
procedure TfrmPuntoVentaLab.Confirmar_Cliente_Prueba;
Var
  qfind1  : TADOQuery;
  qfind2  : TADOQuery;
begin
...
procedure TfrmPuntoVentaLab.Confirmar_Precio_Prueba;
Var
 valor_precio     : Double;
 qprueba          : TADOQuery;
...
procedure TfrmPuntoVentaLab.Agregar_Pacientes(PacienteId : String);
Var
 sqlString : String;
...
procedure TfrmPuntoVentaLab.Agregar_Clientes(ClienteId : String);
Var
 sqlString : String;
...
// If ( qrEntradaPaciente.State in [dsinsert,dsedit] ) Then
 If ( (qrEntradaPaciente.State in [dsinsert, dsedit]) ) And
  ...
  Begin
   ...
   sqlString := ' SELECT * FROM PTCliente (nolock) WHERE GrupoCliente IN ('  + #39 +
                                      DM.qrParametroGrupoVip.Value  + #39 + ',' + #39 +
                                      DM.qrParametroGrupoAcc.Value  + #39 + ',' + #39 +
                                      DM.qrParametroGrupoEmp.Value  + #39 + ',' + #39 +
                                      DM.qrParametroGrupoPriv.Value + #39 + ') '+
...
Function TfrmPuntoVentaLab.Cargar_Valor(campo: String; valor: Variant): String;
begin
 Result := campo + ' - ( ' + VarToStr(valor) + ' ).';
end;


procedure TfrmPuntoVentaLab.Mirar_Valor_CAB;
Var idx : Integer;
begin
...
procedure TfrmPuntoVentaLab.Mirar_Valor_DET;
Var idx : Integer;
begin
...
procedure TfrmPuntoVentaLab.Act_RecIdDetalle;
begin
...
procedure TfrmPuntoVentaLab.GridPruebasEntradasPacienteDetComentarioPropertiesInitPopup(
  Sender: TObject);
Var
 qfind : TADOQuery;
...
procedure TfrmPuntoVentaLab.GridPruebasEntradasPacienteDetResultadoStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.GridPruebasEntradasPacienteDetStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  inherited;
...
procedure TfrmPuntoVentaLab.Cancelar_Entrada;
begin
 If qrEntradaPaciente.State = dsinsert then
  begin
    If qrEntradaPacienteEntradaID.Value = '' then
...
procedure TfrmPuntoVentaLab.Guardar_Entrada;
begin
 inherited;
 Confirmar_Cliente_Prueba;
 Val_Paciente;
...
procedure TfrmPuntoVentaLab.Re_Grabar;
begin
 DM.qrParametro.close;
 DM.qrParametro.open;
...
procedure TfrmPuntoVentaLab.Procesar_Usuario_New;
Var
  Valor : Boolean;
...
Function TfrmPuntoVentaLab.Crear_Clave(cedularnc : String) : Integer;
Var
  Numero  : Double;
  Valor   : Int64;
//  Valor   : Integer;
...
//Creando el Usuario de Internet.
Function TfrmPuntoVentaLab.Crear_Usuario(nombre : String) : String;
Var
  Texto : String;
...
Function TfrmPuntoVentaLab.Valida_Usuario(usuario : String) : Boolean;
Var
 qfind  : TAdoQuery;
begin
...
procedure TfrmPuntoVentaLab.Insertar_Usuario_New(usuario: string; clave: string; name: string; cedula: string;
...
//Validando la Existencia del Usuario Creado.
Function TfrmPuntoVentaLab.Buscar_User_Internet(_customer : String) : Boolean;
Var
 qinter  : TAdoQuery;
begin
  qinter := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.Insertar_Pago_AS400_PuntodeVenta;
Var
  _fecha     : String;
  monto      : Double;
  qfind      : TADOQuery;
...
function TfrmPuntoVentaLab.GetReciboAS400(tipodoc : string; _sucursal : String; _sucAS400: Integer) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
function TfrmPuntoVentaLab.GetSecuenciaAS400(_sucursal : String; _sucAS400: Integer) : Integer;
Var
 _valor   : String;
 numero   : Int64;
 qsecdoc  : TADOQuery;
...
procedure TfrmPuntoVentaLab.RecibosdelAS4001Click(Sender: TObject);
begin
...
Procedure TfrmPuntoVentaLab.Buscar_Campos_Extras(ClienteId :String;Tipo : String);
var
 qfind2 : TADOQuery;
begin
 qfind2 := DM.NewQuery;
 ...
 begin
  ...
  begin
         ...
         Begin
           ...
           ppLabel5.caption   := fieldbyname('Nombre_Sucursal').value;
         ...
         Begin
           ...
           ppLabel161.caption := fieldbyname('Nombre_Sucursal').value;
...
procedure TfrmPuntoVentaLab.No_Procesar_AS400;
Var
  qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaLab.No_Procesar_AS400_Orden;
Var  qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaLab.ImpresionRwPrint;
var
 PP, LabelPOs : Integer;
...
Function TfrmPuntoVentaLab.Estremos(TextE1,TextE2 : String ; LengE :SmallInt):String ;
...
Function TfrmPuntoVentaLab.Verifica_Comentario_Coberturas : integer;
Var
 qfind : TADOQuery;
 strsql : String;
begin
...
Function TfrmPuntoVentaLab.Verifica_Orden_Pruebas_Paternidad : integer;
Var
 qfind : TADOQuery;
 strsql,strPruebaAnt : String;
 SecAnt : Integer;
...
procedure TfrmPuntoVentaLab.Borra_Lebels_Eliminados(Muestrano : String);
var
 qSelTemp : TADOQuery;
 qDelTemp : TADOQuery;
begin
    qSelTemp  := DM.NewQuery;
    qDelTemp  := DM.NewQuery;
    With qSelTemp, sql do
    begin
        Close;
        Text := ' SELECT MUESTRANO,PRUEBAID FROM PTLABELTEMP WHERE MUESTRANO='+#39+Muestrano+#39+
                          ' AND MUESTRANO+PRUEBAID NOT IN (SELECT MUESTRANO+PRUEBAID FROM PTENTRADAPACIENTEDETALLE (nolock) '+
        ...
        Begin
           ...
           While Not Eof Do
           Begin
              With qDelTemp, sql do
              begin
                Close;
                Text := ' DELETE FROM PTLABELTEMP WHERE MUESTRANO='+#39+qSelTemp.FieldByName('Muestrano').Asstring+#39+' AND PRUEBAID='+#39+qSelTemp.FieldByName('PruebaID').Asstring+#39;
                ExecSQL;
              end;
              Next;
           end;
          ...
          begin
            Close;
            Text := ' DELETE FROM PTLABEL WHERE MUESTRANO='+#39+Muestrano+#39;
            ExecSQL;
          end;
//          Generar_Labels;
        end;
...
function TfrmPuntoVentaLab.Verifica_Labels(_muestra: String): Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
Function TfrmPuntoVentaLab.Inserta_Detalle_Int : Boolean;
Var
 qDetalle   : TAdoQuery;
 CPagoTotal : Currency;
begin
...
function TfrmPuntoVentaLab.ActPago : Boolean;
begin
Result := False;
Try
...
function TfrmPuntoVentaLab.ActNotaC : Boolean;
begin
Result := False;
Try
...
procedure TfrmPuntoVentaLab.CancelarCobroAct;
begin
...
Function TfrmPuntoVentaLab.Verifica_Autorizacion : Boolean;
Var
 qAuto  : TAdoQuery;
begin
  qAuto := DM.NewQuery;
...
procedure TfrmPuntoVentaLab.HabilitaConsultas;
Var qact : TADOQuery;
begin
  qact := DM.NewQuery;
  With  qact, sql do
