...
uses
  ...
  WSRefUniversal,cxRichEdit,UrlMon, LMDCustomControl, LMDCustomPanel, LMDCustomBevelPanel,
  LMDSimplePanel, JvMemoryDataset, LMDCustomButton, LMDButton, LMDControl,
  LMDBaseControl, LMDBaseGraphicControl, LMDBaseLabel, LMDCustomLabel, LMDLabel,SenasaRefWS,
  ppBarCod;

type
  TfrmPuntoVentaNC = class(TfrmCustomModule)
    ...
    GridPruebasEntradasPacienteDetSeleccion: TcxGridDBColumn;
    ...
    procedure BtNoAllClick(Sender: TObject);
...
Var
  frmPuntoVentaNC   : TfrmPuntoVentaNC;
...
function TfrmPuntoVentaNC.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
 suc : Boolean;
...
procedure TfrmPuntoVentaNC.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
                                           tipoaplica: string; documentoaplica: string; fecha : TDateTime;
                                           valor: Double; moneda :string; paciente: string; filter: Integer);
Var
 qinsert : TADOQuery;
...
procedure TfrmPuntoVentaNC.CrearCobroAxapta(cliente: string; paciente: string; tipodoc: string;
                                          _cobroid: string; documento: string; fecha: TDateTime;
                                          moneda:  string; aplica: string; _refId: Integer;
                                          valor: Double; _areaId: string; _recId: Integer;
                                          _padreId: string; _cuadro: Integer; _transf: Integer;
...
procedure TfrmPuntoVentaNC.TransferirAxapta1Click(Sender: TObject);
Var
 qupdate : TADOquery;
begin
...
procedure TfrmPuntoVentaNC.CuadredeCaja1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.CuadredeCaja2Click(Sender: TObject);
begin
{
  inherited;
...
procedure TfrmPuntoVentaNC.cxDBCurrencyEdit4PropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.cxDBDateEdit5Exit(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.cxDBImageComboBox7PropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor_Cambio;
end;

procedure TfrmPuntoVentaNC.cxDBTextEdit16KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.RegistrarPruebadelExterior1Click(Sender: TObject);
begin
  Val_Exterior;
end;


procedure TfrmPuntoVentaNC.CbDocumentoPropertiesChange(Sender: TObject);
begin
  Val_Exterior;
end;


procedure TfrmPuntoVentaNC.chkDiagnosticofClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.RefrescarGrid(SoloLectura: Boolean);
begin
...
procedure TfrmPuntoVentaNC.Impresiones;
begin
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaNC.ImpresionRecibo;
...
procedure TfrmPuntoVentaNC.ImpresionNC;
Var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaNC.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.CancelarCobro;
begin
...
procedure TfrmPuntoVentaNC.CancelarCobroAct;
begin
...
procedure TfrmPuntoVentaNC.CancelarOrdenInterfaseAS4001Click(Sender: TObject);
begin
  inherited;
  No_Procesar_AS400_Orden;
end;

function TfrmPuntoVentaNC.GetSecuenciaId : Int64;
Var
 _valor   : String;
 numero   : Int64;
 qsecdoc  : TADOQuery;
...
function TfrmPuntoVentaNC.ActPago : Boolean;
begin
Result := False;
Try
...
function TfrmPuntoVentaNC.ActNotaC : Boolean;
begin
Result := False;
Try
...
function TfrmPuntoVentaNC.GetMuestraNo : String;
Var
 _valor  : String;
 qsecdoc : TADOQuery;
 anio, mes, dia : Word;
...
function TfrmPuntoVentaNC.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;

function TfrmPuntoVentaNC.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;
function TfrmPuntoVentaNC.GetNotaDebito : String;
begin
  result := GetNextSecDoc('ND');
end;
function TfrmPuntoVentaNC.GetDevolucion : String;
begin
  result := GetNextSecDoc('DV');
end;

procedure TfrmPuntoVentaNC.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaNC.Val_Exterior_Detalle;
begin
 If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoExt.Value) Or
    (qrEntradaPacienteTipoDocumento.Value = 3) Or
...
function TfrmPuntoVentaNC.ImporteBrutoExclLineaActual(refrecid : integer ; secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaNC.ImporteBrutoExclLineaActualAplica(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaNC.ImporteBrutoExclLineaActualAplicaAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaNC.TotalDescuentoLinea : Double;
Var
...
function TfrmPuntoVentaNC.ImporteLinea : Double;
Var
...
function TfrmPuntoVentaNC.CalcularCoberturaAplicada : Double;
var
...
function TfrmPuntoVentaNC.Valor_Cobertura(_registro : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.BtInterfaseAS400Click(Sender: TObject);
begin
...
procedure TfrmPuntoVentaNC.RegistrarCobrosTemporales1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.RegistrarFechaPrometida1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.RegistrarNuevoPaciente1Click(Sender: TObject);
Var
 sqlString   : String;
...
procedure TfrmPuntoVentaNC.CodigodeBarra1Click(Sender: TObject);
Var
  Tipo : String;
begin
  inherited;
...
procedure TfrmPuntoVentaNC.ImprimirLabels_sp(_Muestrano : String);
Var
 qprint   : TADOQuery;
 printer  : String;
begin
...
procedure TfrmPuntoVentaNC.Printing_Label(_muestra: String; _label: String; _departamento: String;
                                          _nombre: String; _usuario: String; _descripcion: String; _descripcion2: String;
                                          _secuencia: Integer);
Const
...
procedure TfrmPuntoVentaNC.ConfirmarCobertura1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.btAllClick(Sender: TObject);
begin
  inherited;
 If (qrEntradaPacienteDetalle.RecordCount > 0) Then
 Begin
    ...
    begin
      qrEntradaPacienteDetalle.Edit;
      qrEntradaPacienteDetalleNCR_ESTATUS.AsBoolean := True;
      qrEntradaPacienteDetalle.Next;
    end;
...
procedure TfrmPuntoVentaNC.btAutorizaClick(Sender: TObject);
Var
...
//          Dm.CodProveedor :=  249;
      ...
      Begin
          ...
          case Dm.codArs of
             1  :Begin
                    if UpperCase(Copy(CAfiliado.Nombre,1,3)) <> Copy(Trim(qrEntradapacienteNombrePaciente.Value),1,3) then
                    Begin
                        Screen.Cursor     := crDefault;
                        spMensaje.Visible := False;
      ...
      Begin
          ...
          begin
            ...
            vArrayOfRecdatben2ObjUser := WSUniv.Validacion_de_Contrato(Dm.CurUserUniv, ifThen(qrEntradaPacienteClienteId.Value='C00389','01','03'),StrContrato ,dfamilia,'', CodProvUniv, 1,qrEntradaPacienteDetalle.Recordcount);
          end
          else
          begin
            dfamilia := 0;
            vArrayOfRecdatben2ObjUser := WSUniv.Validacion_de_Contrato(Dm.CurUserUniv, ifThen(qrEntradaPacienteClienteId.Value='C00389','01','03'),qrEntradaPacientePolizaID.Value ,dfamilia,'', CodProvUniv, 1,qrEntradaPacienteDetalle.Recordcount);
          end;

          SetLength(vArrayOfRecdatben2ObjUser, Length(vArrayOfRecdatben2ObjUser));
//          vRecdatben2ObjUser := vArrayOfRecdatben2ObjUser[0];         //  03003304-247  1959-03-16 00:00:00.000     03019562-4     1929-05-18 00:00:00.000
...
procedure TfrmPuntoVentaNC.btcancelarClick(Sender: TObject);
begin
  inherited;
     ...
     begin
      if qrEntradaPacienteEntradaID.Value = '' then
       begin
        ...
        DM.DataBase.Execute('DELETE FROM PTGastosVarioTransNC WHERE Refrecid = '+ qrEntradaPacienteRECID.AsString);
...
procedure TfrmPuntoVentaNC.btclienteClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.btentradaClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
    ...
    begin
      ...
      begin
          if (qrEntradaPacienteTotalPagado.Value = 0) Then
            Credito_St:='N'
          Else if qrEntradaPacienteTotalPagado.Value > 0 then
            Credito_St:='T';
          qrEntradaPacienteDetalle.First;
          DsEntradaPacienteDetalle.Enabled := False;
          while not qrEntradaPacienteDetalle.eof do
          ...
          DsEntradaPacienteDetalle.Enabled := True;
//          qrEntradaPacienteDetalleNCR_ESTATUS.ReadOnly := True;
          qrEntradaPacienteDetalle.First;
      end
      else
      begin
          if (qrEntradaPacienteTotalPagado.Value = 0) And (qrEntradaPacienteNeto.Value = 0) Then
            Credito_St:='N'
          else
            Credito_St:='P';
            qrEntradaPacienteTotalPagado.Value:=0;
            qrEntradaPacienteDetalleNCR_ESTATUS.ReadOnly := False;
      end;
...
procedure TfrmPuntoVentaNC.btgrabarClick(Sender: TObject);
Var
...
begin
 ...
 if (Credito_St <> 'N') then
 Begin
      if  (qrEntradaPaciente.State <> dsinsert) and
      ...
      begin
          ...
          beep;
     If TipoCob = EmptyStr then
     Begin
        EtMensajeDlg('Favor completar datos en Nota de Credito.  Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
        exit;
     end;
 end;
 ...
 Begin
    ...
    while not qrEntradaPacienteDetalle.eof do
    begin
      if qrEntradaPacienteDetalleNCR_ESTATUS.Value = True Then CMark := CMark+1;
      qrEntradaPacienteDetalle.Next;
    end;
    DsEntradaPacienteDetalle.Enabled := True;
    qrEntradaPacienteDetalle.First;
 ...
 If (qrEntradaPacienteDetalle.RecordCount > 0) and (CMark = 0)  then
 Begin
    EtMensajeDlg('Debe seleccionar la(s) prueba(s) a acreditar.  Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
    Exit;
 end;
...
//     qrEntradaPacienteUserId.Value := DM.CurUser;
     ...
     Begin
          ...
          begin
            Close;
            Clear;
            Text :='DELETE FROM PTEntradaPacienteDetalleNC WHERE Refrecid = '+ qrEntradaPacienteRECID.AsString+' And NCR_ESTATUS='+'0';
            ExecSQL;
            Close;
            Clear;
            Text :='SELECT * FROM PTEntradaPacienteDetalleNC (nolock) WHERE Refrecid = '+ qrEntradaPacienteRECID.AsString;
            Open;
          end;
          DsEntradaPacienteDetalle.Enabled := True;
          qrEntradaPacienteDetalle.Edit;
...
//     If Not ExisteCobro And (Act_2da = False) And (TipoCob=EmptyStr) Then Boton_Cobrar;
     If Not Actualizacion_Registros_NC_FAC('N') Then
     begin
           Raise exception.CreateFmt( ' NO Se Pudo Actualizar Registro Nota de Credito. '+ #13 +
...
//    If (qfindSucursal.FieldByName('Impresiones').AsBoolean <> True) Then
    ...
    If not((qrEntradaPacienteTipoDocumento.Value = 4)) then
    Begin
       imprimirNC := False;
       imprimirRecibo := False;
       imprimirFactExterior := False;
    ...
    If imprimirFactExterior Or
       ...
       (qrEntradaPacienteTipoDocumento.Value = 4) then
    begin
    ...
    if (TipoDoc = '4') and (Tipo='N') And
       (copy(EntradaId,1,3) = 'NCR') then
    begin
       sqlString := 'SELECT * FROM PTEntradaPacienteNC (nolock) WHERE ';
       sqlString := sqlString + ' DataAreaId = ' + #39 + DM.CurEmpresa + #39;
       sqlString := sqlString + ' AND RecID= '+#39+InttoStr(RecID)+#39;
...
//    If (imprimirRecibo) and (cobroid <> '') and (TipoCobro = 'RI') then
    ...
    If (qrEntradaPacienteTipoDocumento.Value = 0) or
        (qrEntradaPacienteTipoDocumento.Value = 4) And (Copy(Trim(qrEntradaPacienteMuestrano.value),3,3) <> '000') then
    Begin
//         If qrEntradaPaciente.State in [dsInsert] Then
         If ( Operacion <> '' ) Then
...
procedure TfrmPuntoVentaNC.BtHoldClick(Sender: TObject);
begin
 inherited;
...
procedure TfrmPuntoVentaNC.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntradaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaNC.btnCancelaClick(Sender: TObject);
begin
  inherited;
  spBeneficiario.Visible := False;
end;

procedure TfrmPuntoVentaNC.BtNoAllClick(Sender: TObject);
begin
  inherited;
 If (qrEntradaPacienteDetalle.RecordCount > 0) Then
 Begin
    ...
    begin
      qrEntradaPacienteDetalle.Edit;
      qrEntradaPacienteDetalleNCR_ESTATUS.AsBoolean := false;
      qrEntradaPacienteDetalle.Next;
    end;
    DsEntradaPacienteDetalle.Enabled := True;
    qrEntradaPacienteDetalle.First;
...
procedure TfrmPuntoVentaNC.btnOkClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.btnotacreditoClick(Sender: TObject);
begin
  inherited;
  if  (qrEntradaPacienteTotalPagado.Value = 0) And (qrEntradaPacienteNeto.Value > 0) and (qrEntradaPaciente.State <> dsinsert) and
      (qrEntradaPacienteDetalle.Recordcount > 0) then
  begin
      frmMain.LanzaVentana(-7992);
  end
...
procedure TfrmPuntoVentaNC.btpacienteClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.btpruebaClick(Sender: TObject);
begin
  inherited;
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaNC.FormActivate(Sender: TObject);
begin
  inherited;
  Factura_St := 'N';
end;

procedure TfrmPuntoVentaNC.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.FormDestroy(Sender: TObject);
begin
  lcGeneral.LookAndFeel.GroupOptions.Color := $00F8E3D1;
  if (qrEntradaPacienteEntradaID.asstring = '') And (qrEntradaPacienteRECID.asstring <> '') then
    begin
...
procedure TfrmPuntoVentaNC.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaNC.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaNC.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaNC.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaNC.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.NuevaVenta;
Var strSql : String;
begin
{    With dm.qrUsuarioSucursal,sql do
    begin
        Close;
        Clear;
        Text :=' select DISTINCT u.UserID,Nombre,s.SucursalID,u.UserID+s.SucursalID as Clave from SysUsuarios u, ptUsuarioSucursal s Where u.Userid=s.userid '+
               ' and Rolid in ('+#39+'8'+#39+','+#39+'12'+#39+','+#39+'14'+#39+','+#39+'15'+#39+','+#39+'10'+#39+')';
        Open;
    end;
    if dm.qrUsuarioSucursal.RecordCount > 0 then cbExtCajero.EditValue := EmptyStr;
    ...
    edvalor.Value := 0.00;
    if Not((dm.CurRol = 7) Or (dm.CurRol = 11) Or (dm.CurRol = 13)) Then
    begin
  ...
  //  noseguro.Color := DM.ColorBorra;
    ...
    qrEntradaPacienteTipoDocumento.Value := 4;
    qrEntradaPacienteUserId.Value := DM.CurUser;
...
procedure TfrmPuntoVentaNC.HabilitaConsultas;
Var qact : TADOQuery;
begin
  With qrEntradaPaciente, sql do
  begin
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteAfterPost(DataSet: TDataSet);
Var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteClienteIDChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaNC.qrEntradaPacientePACIENTEIDValidate(Sender: TField);
begin
  inherited;
  Val_Paciente;
end;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
  qrEntradaPaciente.Edit;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
//  Val_Descuento;
end;

procedure TfrmPuntoVentaNC.BalanceActual1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.VerTransacciones1Click(Sender: TObject);
begin
  inherited;
  If (qrEntradaPacientePacienteId.Value <> '') Or
  Not(qrEntradaPacientePacienteId.IsNull) Then
...
procedure TfrmPuntoVentaNC.Val_Exterior;
begin
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVentaNC.Val_Paciente;
begin
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaNC.Val_Forma_Pago(Forma_Pago: string);
begin
 LbCondicion.Caption := '';
...
procedure TfrmPuntoVentaNC.Leer_Forma_Pago;
begin
 LbCondicion.Caption := '';
...
procedure TfrmPuntoVentaNC.Val_Balance;
begin
      if not((qrEntradaPacientePacienteId.Value ='00029127') or (qrEntradaPacientePacienteId.Value ='00008805') or
         (qrEntradaPacientePacienteId.Value ='00018822') or (qrEntradaPacientePacienteId.Value ='00029448') or
         (qrEntradaPacientePacienteId.Value ='00006242')) then
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetalleBeforeDelete(DataSet: TDataSet);
begin
  inherited;
  //Pruebas de los Seguros.
  curCoberturaAplicada := DM.CurCoberturaAplicada(qrEntradaPacienteRECID.Value); //DM.CurCoberturaAplicada(_recorId)
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
  comboborrar := False;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
  comboborrar := False;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
 inherited;
 If qrEntradaPacienteDetalle.State in [dsEdit, dsInsert] then
  Begin
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetalleDescuentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
Var
 valor_precio       : Double;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteDoctorIDChange(Sender: TField);
begin
  inherited;
//  Buscar_Doctor;
end;

procedure TfrmPuntoVentaNC.EdDoctorDblClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7984);
end;

procedure TfrmPuntoVentaNC.EdDoctorPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor;
end;

procedure TfrmPuntoVentaNC.EdNombreDoctorDblClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7984);
end;

procedure TfrmPuntoVentaNC.Buscar_Doctor;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaNC.Buscar_Doctor_Cambio;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteNombrePacienteValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
 inherited;
...
procedure TfrmPuntoVentaNC.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.Materiales1Click(Sender: TObject);
begin
  inherited;
...
function TfrmPuntoVentaNC.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaNC.Buscar_Linea: Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.MenuItem1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.ActTotales;
Var
 qfind : TADOQuery;
begin
 If (qrEntradaPacienteDetalle.RecordCount > 0) Then
...
procedure TfrmPuntoVentaNC.ActTotales_Sel;
Var SPrecio,SDescuento,SCobertura,SAdicional : Currency;
Var pCombo,cCombo,intCursor : Integer;
begin
  pCombo:=0;
  cCombo:=0;
  If (qrEntradaPacienteDetalle.RecordCount > 0) Then
  Begin
    ...
    begin
       ...
       begin
          intCursor := qrEntradaPacienteDetalle.RecNo;
//        if (qrEntradaPacienteDetalleNCR_ESTATUS.Value = True) and (qrEntradaPacienteDetalleCOMBO.Value = 1) then
//        begin
//          pCombo:=1;
//          cCombo:=cCombo+1;
//        end
...
//        end;
    ...
    DsEntradaPacienteDetalle.Enabled := True;
    qrEntradaPacienteDetalle.First;
    qrEntradaPacienteDetalle.MoveBy(intCursor);
{    if pCombo=1 then
    begin
        qrEntradaPacienteDetalle.First;
        DsEntradaPacienteDetalle.Enabled := False;
        while not qrEntradaPacienteDetalle.eof do
        begin
           if (qrEntradaPacienteDetalleCOMBO.Value = 1) and (cCombo=1) Then
           begin
            qrEntradaPacienteDetalle.Edit;
            qrEntradaPacienteDetalleNCR_ESTATUS.Value := True;
            SPrecio     := SPrecio+qrEntradaPacienteDetallePrecio.value;
            SDescuento  := SDescuento+qrEntradaPacienteDetalleDescuentoLineaAplicado.value;
            SCobertura  := SCobertura+qrEntradaPacienteDetalleCoberturaAplicada.value;
            SAdicional  := SAdicional+qrEntradaPacienteDetalleAdicional.value;
           ...
           begin
            qrEntradaPacienteDetalle.Edit;
            qrEntradaPacienteDetalleNCR_ESTATUS.Value := False;
            qrEntradaPaciente.Edit;
            qrEntradaPacienteBruto.Value := qrEntradaPacienteBruto.Value - (qrEntradaPacienteDetallePrecio.value+qrEntradaPacienteDetalleAdicional.value);
            qrEntradaPacienteDescuento.Value := qrEntradaPacienteDescuento.Value - Dm.Redondeo(qrEntradaPacienteDetalleDescuentoLineaAplicado.value+ qrEntradaPacienteDescuentoBono.Value);
//            SPrecio     := SPrecio+qrEntradaPacienteDetallePrecio.value;
//            SDescuento  := SDescuento+qrEntradaPacienteDetalleDescuentoLineaAplicado.value;
//            SCobertura  := SCobertura+qrEntradaPacienteDetalleCoberturaAplicada.value;
//            SAdicional  := SAdicional+qrEntradaPacienteDetalleAdicional.value;
...
procedure TfrmPuntoVentaNC.AsignarDescuentoAutorizadoporCobros1Click(
  Sender: TObject);
begin
...
procedure TfrmPuntoVentaNC.AsignarDescuentoPermitidoalEmpleado1Click(
  Sender: TObject);
begin
  inherited;
  If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoSeg.Value) And
...
procedure TfrmPuntoVentaNC.AsignarDescuentoPermitidoalUsuario1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.RecalcularLineas;
begin
 qrEntradaPacienteDetalle.DisableControls;
 qrEntradaPacienteDetalle.First;
...
procedure TfrmPuntoVentaNC.RecibodeCobro1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.EliminarDescuentoAplicado1Click(Sender: TObject);
begin
  inherited;
  qrEntradaPaciente.Edit;
  qrEntradaPacienteDescuentoPorc.Value := 0;
...
procedure TfrmPuntoVentaNC.EliminarOrdenesenHold1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.MarcarPruebaNOProcesar1Click(Sender: TObject);
begin
  inherited;
  No_Procesar;
end;
...
function TfrmPuntoVentaNC.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaNC.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmPuntoVentaNC.Devoluciones1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991, qrEntradaPacienteRECID.asstring,'DV');
end;

procedure TfrmPuntoVentaNC.DistribucionCobrado1Click(Sender: TObject);
begin
  inherited;
     frmMain.LanzaVentana(-7981);
     if (Tiene_Balance = 0) Then
...
procedure TfrmPuntoVentaNC.EdCoberturaValorExit(Sender: TObject);
begin
  inherited;
  Act_Cobertura
end;
...
procedure TfrmPuntoVentaNC.Act_Cobertura;
begin
 if qrEntradaPaciente.State in [dsedit, dsinsert] then
  begin
    qrEntradaPacienteDescuentoValor.Value := 0;
...
function TfrmPuntoVentaNC.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.GastosVarios1Click(Sender: TObject);
begin
  inherited;
...
function TfrmPuntoVentaNC.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
function TfrmPuntoVentaNC.GetEntradaID_Hold : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
procedure TfrmPuntoVentaNC.Boton_Cobrar;
begin
...
procedure TfrmPuntoVentaNC.Viejo_Cobrar;
begin
  inherited;
...
procedure TfrmPuntoVentaNC.CrearCobro;
Var
 qinsert    : TADOQuery;
...
// cobroid := IntToStr(DM.Get_Secuencia('Secuencia'));
 ...
 If (qrEntradaPacienteTipoDocumento.Value = 0) And
   ...
   Begin
     ...
     qformapago.close;
     qformapago.SQL.Text := ' SELECT * FROM PTFormaDePago (nolock) '+
...
procedure TfrmPuntoVentaNC.RefrescarCobro;
Var
 qfind : TADOQuery;
begin
  DM.qrParametro.Close;
  ...
  cobroid := DM.Get_Secuencia_Big('COBRO', DM.CurSucursal);
   ...
   begin
      Close;
      Text := ' SELECT * From PTFormaDePago (nolock) '+
              ' WHERE moneda = '+ #39 + qrEntradaPacienteMonedaID.value + #39 +
              ' AND DataAreaId = ' + #39 + DM.CurEmpresa + #39 +
              ' ORDER BY Orden';

      Open;
      if IsEmpty then DM.Error('Error Cargando Formas de Pago en '+qrEntradaPacienteMonedaID.value+'.  Verifique.');
   end;
...
procedure TfrmPuntoVentaNC.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
Function TfrmPuntoVentaNC.buscar_valores;
Var
  valor : Boolean;
begin
  valor := True;
...
procedure TfrmPuntoVentaNC.correccion;
begin
  mdPago.First;
  While Not mdPago.Eof do
   Begin
...
function TfrmPuntoVentaNC.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmPuntoVentaNC.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
// cobroid := IntToStr(DM.Get_Secuencia('Secuencia'));
...
procedure TfrmPuntoVentaNC.CrearDevolucion(Tipo: String;UserId: String);
Var
 qinsert : TADOQuery;
begin
// cobroid := IntToStr(DM.Get_Secuencia('Secuencia'));
...
procedure TfrmPuntoVentaNC.ActNotaCredito;
Var
 qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
 ...
 qrEntradaPaciente.Edit;
 qrEntradaPacienteTotalPagado.Value := ValorNC;
 qrEntradaPaciente.Post;
...
procedure TfrmPuntoVentaNC.ActDevolucion;
Var
 qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
...
procedure TfrmPuntoVentaNC.CrearNotaDebito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVentaNC.ActNotaDebito;
Var
qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
...
//                       qrEntradaPAcienteEntradaId.value,qfindcobro.FieldByName('Fecha').value, ValorND * -1,
 ...
 If Seg_Late then ValorND := 0;
  ...
  begin
     qrEntradaPaciente.Edit;
     qrEntradaPacienteTotalPagado.Value := ValorND;
     qrEntradaPaciente.Post;
  end;
 FreeAndNil(qupdate);
 FreeAndNil(qfindcobro);
...
procedure TfrmPuntoVentaNC.VolantedePruebasARS1Click(Sender: TObject);
begin
  inherited;
//  Application.ProcessMessages;
    Buscar_Cliente;
...
procedure TfrmPuntoVentaNC.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
//  Application.ProcessMessages;
  if Trim(qrEntradaPacienteEntradaID.Value) <> EmptyStr then
...
procedure TfrmPuntoVentaNC.vwDoctoresKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.FacturaExterior1Click(Sender: TObject);
begin
//  Application.ProcessMessages;
...
procedure TfrmPuntoVentaNC.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := _recorId;
  qrEntradaPaciente.Open;
...
procedure TfrmPuntoVentaNC.ActInterface;
begin
{
 Act_Hold;
...
procedure TfrmPuntoVentaNC.RefrescarInterface;
begin
// actinterface;
...
procedure TfrmPuntoVentaNC.Val_Descuento;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
 Buscar_Cliente;
{
...
procedure TfrmPuntoVentaNC.VerificarPagoDiferencia;
Var
 qfind : TADOQuery;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
...
function TfrmPuntoVentaNC.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
function TfrmPuntoVentaNC.CanMenuEspecial;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaNC.Asignar_Descuento;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaNC.Act_Hold;
var
 qfind : TADOQuery;
begin
{
...
//Eliminando Los Documentos en Hold.
procedure TfrmPuntoVentaNC.Del_Hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
   ...
   Begin
     ...
     While Not qfind.Eof do
      Begin
        ...
        DM.DataBase.Execute('DELETE FROM PTGastosVarioTransNC WHERE Refrecid = '+ qfind.FieldByName('RecId').AsString);
        qfind.Next;
      End;
   End;
...
procedure TfrmPuntoVentaNC.DepositosSucursales1Click(Sender: TObject);
begin
...
procedure TfrmPuntoVentaNC.No_Procesar;
Var
 qact : TADOQuery;
begin
{
...
procedure TfrmPuntoVentaNC.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.Buscar_Muestra;
Var
 Dias   : Extended;
 qfind  : TADOQuery;
begin
...
//Validando Los Datos de la 2da. Muestra.
procedure TfrmPuntoVentaNC.Val_2da_Muestra;
Var
 qfind  : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.Buscar_Combo;
begin
...
procedure TfrmPuntoVentaNC.Borrar_Combo;
begin
...
procedure TfrmPuntoVentaNC.Actu_Precio_Combo;
Var
  valor : Double;
  qfind : TAdoQuery;
Begin
...
procedure TfrmPuntoVentaNC.Insertar_Combo_Precio;
begin
...
procedure TfrmPuntoVentaNC.Insertar_Combo_Blanco;
begin
 While Not qfindcombo.Eof Do
  Begin
   If (qrEntradaPacienteDetallePruebaID.Value = '') Or
...
procedure TfrmPuntoVentaNC.Act_Cliente;
Var
  texto       : String;
...
//Buscando los Datos del Cliente a Facturar y Sus Parametros.
procedure TfrmPuntoVentaNC.Buscar_Cliente;
begin
// If (qrEntradaPacienteClienteId.Value <> '') then
//  Begin
...
//Buscando los Datos del PACIENTE Registrado y Sus Parametros.
procedure TfrmPuntoVentaNC.Buscar_Paciente;
begin
...
//Buscando los Datos del Grupo del Cliente.
Procedure TfrmPuntoVentaNC.Buscar_Grupo_Clt(Grupo: string);
begin
...
//Buscando los Datos del Grupo del Paciente.
Procedure TfrmPuntoVentaNC.Buscar_Grupo_Pac(Grupo: string);
begin
...
procedure TfrmPuntoVentaNC.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
//Insertando Los Datos de la Tarjeta de Descuento.
procedure TfrmPuntoVentaNC.Insert_Card_Descuento;
...
begin
 If (qrEntradaPacienteDescuentoTexto.Value <> 'DESCUENTO SUCURSAL') And
   ...
   Begin
     ...
     qactu := DM.NewQuery;
     qactu.Close;
     qactu.SQL.Text := ' UPDATE PTTarjetaBono With (rowlock) With (rowlock) SET '+
//                       ' Activo = 0, '+
...
procedure TfrmPuntoVentaNC.InstructivodeInternet1Click(Sender: TObject);
...
procedure TfrmPuntoVentaNC.CabeFactSeguroBeforePrint(Sender: TObject);
begin
  LbFechayHora2.Caption := 'Fecha Ent.: ' + qrEntradaPacienteFECHA.AsString +
                          ' * Hora Ent.: ' + qrEntradaPacienteHORAENTRADA.AsString;
end;

procedure TfrmPuntoVentaNC.ppHeaderBand4BeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaNC.ppHeaderBand5BeforePrint(Sender: TObject);
Var Texto1, Texto2 : String;
begin
 Texto1 := '';
 Texto2 := '';
...
procedure TfrmPuntoVentaNC.ppHeaderBand6BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaNC.ppSummaryFacturaSeguroBeforePrint(Sender: TObject);
begin
  ...
  ppLabel179.Caption          := FormatFloat('##,##0.00', qrEntradaPacienteNeto.Value);
{
...
procedure TfrmPuntoVentaNC.ppSummaryBand4BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.ppSummaryFactPacienteConSeguroBeforePrint(Sender: TObject);
begin
  inherited;
  Buscar_Cliente;
  ...
  If (qrEntradaPacienteOrigen.Value = dm.qrParametroGrupoSeg.Value) And (dm.Verifica_Universal_UroCopro(qrEntradaPacienteRecId.AsString)) Then
...
procedure TfrmPuntoVentaNC.ppSummaryFactPacienteSinSeguroBeforePrint(Sender: TObject);
begin
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVentaNC.ppDetailBand3BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaNC.ppDetailBand4BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaNC.ppDetailBandSinSeguroBeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaNC.ppDetailBandConSeguroBeforePrint(Sender: TObject);
begin
  qfindPrueba := DM.Find_Ldr('SELECT * FROM PtPrueba (nolock) WHERE PruebaID = :pru', qrEntradaPacienteDetallePruebaId.Value);
  If qfindPrueba.FieldByName('Font_Bold').Value = True Then
...
procedure TfrmPuntoVentaNC.Insertar_Materiales_Prueba;
Var
...
procedure TfrmPuntoVentaNC.Insertar_Materiales_Envase;
Var
 qfind, qinsert : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.Insertar_Materiales_Sangre;
Var
 qfind, qinsert : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaNC.BuscarDia(dia: Integer) : Integer;
Var
 valor : Integer;
begin
 valor := 0;
...
function TfrmPuntoVentaNC.FechaPrometida(Prueba: string) : TDate;
Var
 fecha : TDate;
 qtest : TADOQuery;
 qfrec : TADOQuery;
...
procedure TfrmPuntoVentaNC.Insertar_LabelTemp;
Var
 Valor      : String;
 Qinsert    : TADOQuery;
begin
...
function TfrmPuntoVentaNC.Validar_Label_Temp(_paciente: String; _entrada: String;
                                           _muestra: String; _prueba: String): Boolean;
Var
 qfind : TADOQuery;
 valor : Boolean;
...
procedure TfrmPuntoVentaNC.Crear_Labels_Temp(_secuenciaact: integer);
Var
 qbuscar  : TADOQuery;
begin
 _total_sangre  := 0;
...
procedure TfrmPuntoVentaNC.Buscar_Label_Temp(_paciente: String; _sucursal: String; _entrada: String;
                                           _muestra: String; TipoMuestra: String; _departamento: String;
                                           _medio: String; _color: String; _total: Integer);
Var
 qdata  : TADOQuery;
...
//Insertando la Prueba Registrada en la Tabla Temporal
procedure TfrmPuntoVentaNC.Update_Label_Temp(_paciente: String; _entrada: String; _muestra: String;
                                           _prueba: String; _label: String; _labelglobal: String;
                                           _labelunico: String; _desc: String; _recid: Integer;
                                           _secuencia: Integer; _numero: Integer);
Var
...
procedure TfrmPuntoVentaNC.Update_Label_Descripcion(_label: String; _descripcion: String);
Var
 qactu    : TADOQuery;
begin
  qactu := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.Generar_Labels;
Begin
{
  Insertar_LabelTemp;
...
procedure TfrmPuntoVentaNC.Confirmar_Cliente_Prueba;
Var
  qfind1  : TADOQuery;
  qfind2  : TADOQuery;
begin
...
procedure TfrmPuntoVentaNC.Confirmar_Precio_Prueba;
Var
 valor_precio     : Double;
 qprueba          : TADOQuery;
...
//                         curCoberturaAplicada := curCoberturaAplicada + 1;
                         ...
                         valor_precio := DM.ValidarSeguroPruebaCobertura_Precio(qrEntradaPacienteClienteID.Value,
                                                                                qrEntradaPacienteDetallePruebaID.Value,
                                                                                qrEntradaPacienteMonedaID.Value,
                                                                                qrEntradaPacienteSucursalID.Value,formatdatetime('yyyymmdd',qrEntradaPacienteFecha.Value));
                         If (valor_precio > 1) Then
                           Begin
//                             qrEntradaPacienteDetalle.Edit;
//                             qrEntradaPacienteDetalleCoberturaAplica.Value := 0;
...
procedure TfrmPuntoVentaNC.Agregar_Pacientes(PacienteId : String);
Var
 sqlString : String;
...
procedure TfrmPuntoVentaNC.Agregar_Clientes(ClienteId : String);
Var
 sqlString : String;
 qfind, qfindciudad : TADOQuery;
begin
// If ( qrEntradaPaciente.State in [dsinsert,dsedit] ) Then
 If ( (qrEntradaPaciente.State in [dsinsert, dsedit]) ) And
  ...
  Begin
   ...
   If (DM.qrPacientes.RecordCount > 0) Then
    Begin
      qfind       := DM.Find('SELECT * FROM PTProyecto (nolock) Where ClienteID = :clt', ClienteId);
      qfindciudad := DM.Find_Ldr('SELECT * FROM PTCIUDAD (nolock) Where CiudadID = :ciu', DM.qrPacientesCiudadID.AsString);
...
Function TfrmPuntoVentaNC.Cargar_Valor(campo: String; valor: Variant): String;
begin
 Result := campo + ' - ( ' + VarToStr(valor) + ' ).';
end;


procedure TfrmPuntoVentaNC.Mirar_Valor_CAB;
Var idx : Integer;
begin
...
procedure TfrmPuntoVentaNC.Mirar_Valor_DET;
Var idx : Integer;
begin
...
procedure TfrmPuntoVentaNC.Act_RecIdDetalle;
begin
...
procedure TfrmPuntoVentaNC.GridPruebasEntradasPacienteDetComentarioPropertiesInitPopup(
  Sender: TObject);
Var
 qfind : TADOQuery;
...
procedure TfrmPuntoVentaNC.GridPruebasEntradasPacienteDetEditValueChanged(
  Sender: TcxCustomGridTableView; AItem: TcxCustomGridTableItem);
begin
  inherited;
  ActTotales_Sel;
...
procedure TfrmPuntoVentaNC.GridPruebasEntradasPacienteDetStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  inherited;
...
procedure TfrmPuntoVentaNC.Cancelar_Entrada;
begin
 If qrEntradaPaciente.State = dsinsert then
  begin
    If qrEntradaPacienteEntradaID.Value = '' then
...
procedure TfrmPuntoVentaNC.Guardar_Entrada;
begin
 inherited;
 Confirmar_Cliente_Prueba;
 Val_Paciente;
...
procedure TfrmPuntoVentaNC.Re_Grabar;
begin
 DM.qrParametro.close;
 DM.qrParametro.open;
...
procedure TfrmPuntoVentaNC.Procesar_Usuario_New;
Var
  Valor : Boolean;
...
Function TfrmPuntoVentaNC.Crear_Clave(cedularnc : String) : Integer;
Var
  Numero  : Double;
  Valor   : Int64;
//  Valor   : Integer;
...
//Creando el Usuario de Internet.
Function TfrmPuntoVentaNC.Crear_Usuario(nombre : String) : String;
Var
  Texto : String;
...
Function TfrmPuntoVentaNC.Valida_Usuario(usuario : String) : Boolean;
Var
 qfind  : TAdoQuery;
begin
...
procedure TfrmPuntoVentaNC.Insertar_Usuario_New(usuario: string; clave: string; name: string; cedula: string;
...
//Validando la Existencia del Usuario Creado.
Function TfrmPuntoVentaNC.Buscar_User_Internet(_customer : String) : Boolean;
Var
 qinter  : TAdoQuery;
begin
  qinter := DM.NewQuery;
...
procedure TfrmPuntoVentaNC.Insertar_Pago_AS400_PuntodeVenta;
Var
  _fecha     : String;
  monto      : Double;
  qfind      : TADOQuery;
...
function TfrmPuntoVentaNC.GetReciboAS400(tipodoc : string; _sucursal : String; _sucAS400: Integer) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
function TfrmPuntoVentaNC.GetSecuenciaAS400(_sucursal : String; _sucAS400: Integer) : Integer;
Var
 _valor   : String;
 numero   : Int64;
 qsecdoc  : TADOQuery;
...
procedure TfrmPuntoVentaNC.RecibosdelAS4001Click(Sender: TObject);
begin
...
Procedure TfrmPuntoVentaNC.Buscar_Campos_Extras(ClienteId :String;Tipo : String);
var
 qfind2 : TADOQuery;
begin
 qfind2 := DM.NewQuery;
 ...
 begin
  ...
  Add(' (Select Cod_Prov_Ref from ptcliente (nolock) Where ClienteID='+#39+qrEntradaPacienteClienteID.value+#39+' And DataAreaId = '+#39+DM.CurEmpresa+#39+') As Cod_Prov_Ref, ' );
...
procedure TfrmPuntoVentaNC.No_Procesar_AS400;
Var
  qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaNC.No_Procesar_AS400_Orden;
Var
  qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaNC.ImpresionRwPrint;
var
 PP, LabelPOs : Integer;
...
Function TfrmPuntoVentaNC.Estremos(TextE1,TextE2 : String ; LengE :SmallInt):String ;
...
Function TfrmPuntoVentaNC.Verifica_Comentario_Coberturas : integer;
Var
 qfind : TADOQuery;
 strsql : String;
begin
...
Function TfrmPuntoVentaNC.Verifica_Orden_Pruebas_Paternidad : integer;
Var
 qfind : TADOQuery;
 strsql,strPruebaAnt : String;
 SecAnt : Integer;
...
Function TfrmPuntoVentaNC.BuscaNumeroOrden(CobroID : String) : String;
Var
 qinter  : TAdoQuery;
begin
  qinter := DM.NewQuery;
  ...
  FreeAndNil(qinter);
End;
Function TfrmPuntoVentaNC.Inserta_Detalle_Int : Boolean;
Var
 qDetalle   : TAdoQuery;
 CPagoTotal : Currency;
begin
       ...
       begin
           ...
           begin
               ...
               Add('  INSERT INTO PTCobroDetalleInt (CobroID, FormaDePagoID, Monto, Orden, '+
                           ' RefRecid, MonedaID, MontoMST, ValorTotalMST,SinPrFilter, RecId) '+
...
function TfrmPuntoVentaNC.Actualizacion_Registros_NC_FAC(DocID : String) : Boolean;
begin
Result := False;
Try
...
procedure TfrmPuntoVentaNC.Eliminar_Temporal;
Begin
