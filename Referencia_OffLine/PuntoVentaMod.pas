...
uses
  ...
  cxRichEdit,UrlMon, LMDCustomControl, LMDCustomPanel, LMDCustomBevelPanel,
  WebservicePalic, LMDSimplePanel, JvMemoryDataset, LMDCustomButton, LMDButton, LMDControl,
  LMDBaseControl, LMDBaseGraphicControl, LMDBaseLabel, LMDCustomLabel, LMDLabel,
  InvokeRegistry, xmldom, Provider, Xmlxform, Rio, SOAPHTTPClient, DBClient,
  ppRichTx,Printers,SenasaRefWS, ppBarCod, wsreferenciaAutorizacion,Simetricaws,Palic,
  Universal,XSBuiltIns,WSdgii;

type
  TfrmPuntoVentaMod = class(TfrmCustomModule)
    ...
    dbDoctorCodigo_Doctor: TcxGridDBColumn;
    dbDoctorNombre: TcxGridDBColumn;
    ...
    procedure ppCabeFactSeguroBeforePrint(Sender: TObject);
    ...
    procedure dbDoctorSeleccionPropertiesEditValueChanged(Sender: TObject);
  protected
    ...
    Procedure Insertar_Usuario_New(usuario: string; clave: string; name: string;
                                   ...
                                   actual: string);
    Procedure Valida_Afiliado_Simetrica;
  private
...
Var
  frmPuntoVentaMod   : TfrmPuntoVentaMod;
...
uses ActionsDM, DataModule, Main, Pymeconst,XMLIntf, XMLDoc, SoapConst, UInterfaseAs400;

{$R *.dfm}


function TfrmPuntoVentaMod.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
 suc : Boolean;
...
procedure TfrmPuntoVentaMod.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
                                           tipoaplica: string; documentoaplica: string; fecha : TDateTime;
                                           valor: Double; moneda :string; paciente: string; filter: Integer);
Var
 qinsert : TADOQuery;
         ...
         begin
            ...
            Text := ' INSERT INTO PTClienteTransacciones(ClienteId, fecha, TipoDoc, Documento, '+
                    ...
                    ' RecId) VALUES ( '+#39+cliente+#39+','+#39+FormatDateTime('yyyymmdd', fecha)+#39+','+#39+tipodoc+#39+','+
                                        ...
                                        #39+paciente+#39+','+#39+filter+#39+','+#39+IntToStr(GetSecuenciaId)+#39+')';
...
procedure TfrmPuntoVentaMod.CrearCobroAxapta(cliente: string; paciente: string; tipodoc: string;
                                          _cobroid: string; documento: string; fecha: TDateTime;
                                          moneda:  string; aplica: string; _refId: Integer;
                                          valor: Double; _areaId: string; _recId: Int64;
                                          _padreId: string; _cuadro: Integer; _transf: Integer;
...
procedure TfrmPuntoVentaMod.TransferirAxapta1Click(Sender: TObject);
Var
 qupdate : TADOquery;
begin
...
procedure TfrmPuntoVentaMod.CuadredeCaja1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.CuadredeCaja2Click(Sender: TObject);
begin
{
  inherited;
...
procedure TfrmPuntoVentaMod.cxDBCurrencyEdit4PropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.cxDBDateEdit5Exit(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.cxDBImageComboBox7PropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor_Cambio;
end;

procedure TfrmPuntoVentaMod.cxDBMemo2PropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.cxDBTextEdit16KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.dbDoctorSeleccionPropertiesEditValueChanged(
  Sender: TObject);
var
  ARadioGroup: TcxRadioGroup;
  AGridSite: TcxGridSite;
  AView: TcxGridTableView;
  i: Integer;
begin
  inherited;
  ARadioGroup := Sender as TcxRadioGroup;
  AGridSite :=  ARadioGroup.Parent as TcxGridSite;
...
procedure TfrmPuntoVentaMod.RegistrarPruebadelExterior1Click(Sender: TObject);
begin
  Val_Exterior;
end;


procedure TfrmPuntoVentaMod.CbDocumentoPropertiesChange(Sender: TObject);
begin
  Val_Exterior;
end;


procedure TfrmPuntoVentaMod.chkDiagnosticofClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.RefrescarGrid(SoloLectura: Boolean);
begin
...
procedure TfrmPuntoVentaMod.Impresiones;
begin
  DM.qrParametro.close;
  DM.qrParametro.open;
  ...
  CotizacinFactura1.Enabled       := False;
  ...
  If Copy(qrEntradaPacienteENTRADAID.Value,1,3) = 'HOL' Then
    Begin
      CotizacinFactura1.Enabled := True;
    End;

end;


procedure TfrmPuntoVentaMod.ImpresionRecibo;
           ...
           Begin
                  ...
                  begin
                      ...
                      Add('select Distinct e.NombrePaciente ,e.ClienteNombre, c.ReciboNo , c.EntradaId ,e.Muestrano as Muestrano,'+
                           ...
                           '  (Select Convert(Varchar(200),NotaNCreditoBalance) from PtParametro (nolock )) as NotaNCredito, c.TurnoID as Autorizacion, '+
                      ...
                      Begin
                          ...
                          begin
                              If (frmMain.frmTmpMod.qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoExt.Value) Or
                                 (frmMain.frmTmpMod.qrEntradaPacienteTipoDocumento.Value = 3) Or
...
procedure TfrmPuntoVentaMod.ImpresionNC;
Var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaMod.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.CancelarCobro;
begin
...
procedure TfrmPuntoVentaMod.CancelarCobroAct;
begin
...
procedure TfrmPuntoVentaMod.CancelarOrdenInterfaseAS4001Click(Sender: TObject);
begin
  inherited;
  No_Procesar_AS400_Orden;
end;

function TfrmPuntoVentaMod.GetSecuenciaId : Int64;
Var
 _valor   : String;
 numero   : Int64;
 qsecdoc  : TADOQuery;
...
function TfrmPuntoVentaMod.ActPago : Boolean;
Var
 _valor   : String;
  i       : Integer;
 qsecdoc  : TADOQuery;
...
function TfrmPuntoVentaMod.ActNotaC : Boolean;
Var
 _valor   : String;
  i       : Integer;
 qsecdoc  : TADOQuery;
...
function TfrmPuntoVentaMod.GetMuestraNo : String;
Var
 _valor  : String;
 qsecdoc : TADOQuery;
 anio, mes, dia : Word;
...
function TfrmPuntoVentaMod.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;

function TfrmPuntoVentaMod.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;
function TfrmPuntoVentaMod.GetNotaDebito : String;
begin
  result := GetNextSecDoc('ND');
end;
function TfrmPuntoVentaMod.GetDevolucion : String;
begin
  result := GetNextSecDoc('DV');
end;

procedure TfrmPuntoVentaMod.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaMod.Val_Exterior_Detalle;
begin
 If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoExt.Value) Or
    (qrEntradaPacienteTipoDocumento.Value = 3) Or
...
function TfrmPuntoVentaMod.ImporteBrutoExclLineaActual(refrecid : int64 ; secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaMod.ImporteBrutoExclLineaActualAplica(refrecid : int64 ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaMod.ImporteBrutoExclLineaActualAplicaAndCobertura(refrecid : int64 ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaMod.TotalDescuentoLinea : Double;
Var
...
function TfrmPuntoVentaMod.ImporteLinea : Double;
Var
...
function TfrmPuntoVentaMod.CalcularCoberturaAplicada : Double;
var
...
function TfrmPuntoVentaMod.Valor_Cobertura(_registro : Int64) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.CodigodeBarra1Click(Sender: TObject);
Var
  Tipo : String;
begin
  inherited;
...
procedure TfrmPuntoVentaMod.ImprimirLabels_sp(_Muestrano : String);
Var
 qprint   : TADOQuery;
 printer  : String;
begin
...
procedure TfrmPuntoVentaMod.Printing_Label(_muestra: String; _label: String; _departamento: String;
                                          _nombre: String; _usuario: String; _descripcion: String;_descripcion2 : String;
                                          _secuencia: Integer);
Const
...
procedure TfrmPuntoVentaMod.BtInterfaseAS400Click(Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.RegistrarCobrosTemporales1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.RegistrarFechaPrometida1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.RegistrarNuevoPaciente1Click(Sender: TObject);
Var
 sqlString   : String;
...
procedure TfrmPuntoVentaMod.ConfirmarCobertura1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.btAceptaClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.btAceptaNCFClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.btAutorizaClick(Sender: TObject);
Var
//     CAfiliado                    : cRefAfiliado;
     qrDoctorArs                  : TAdoQuery;
     qrBuscaAutoriza              : TAdoQuery;
...
begin
  ...
  begin
     EtMensajeDlg('Número de Afiliado No puede estar en blanco.  Verifique.', etAviso, [etOk],0, dm.Imagenes.Items[6].Bitmap,true);
     if cxDBTextEdit16.enabled then  cxDBTextEdit16.SetFocus;
  end
  else if (Trim(qrEntradaPacienteCOD_DIAG.Value) = EmptyStr) Then
  begin
     EtMensajeDlg('código de diagnóstico No puede estar en blanco.  Verifique.', etAviso, [etOk],0, dm.Imagenes.Items[6].Bitmap,true);
...
//      vURLWSDL     := 'http://10.0.0.30/wsreferencia/referenciawebservice.asmx';
  Try
      ...
      begin
          EtMensajeDlg('Ars No está configurada para autorización web.', etAviso, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
          exit;
      end;
      If (qAutoriza.FieldByName('WsArsid').AsString = GrupoArsUniversal) And
         (qrEntradaPacienteBruto.Value > Monto_Limite)Then
      Begin
          EtMensajeDlg('Monto Facturado sobrepasa límite (RD$'+CurrToStr(Monto_Limite)+') via Web-Services para Ars. Universal.  Consulte un representante.', etAviso, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
          exit;
      end;
      If (qAutoriza.FieldByName('WsArsid').AsString = GrupoArsUniversal) And
...
//          Dm.CodProveedor :=  249;
      ...
      Begin
        //  Dm.vURLWSDL     := 'http://172.16.30.65/WsHumanoTest/SimetricaWS.asmx';
          qrBuscaAutoriza := DM.NewQuery;
          qrBuscaAutoriza := DM.Find('SELECT Top 1 * FROM PtReclamo (nolock) WHERE Estado='+#39+'2'+#39+' And Muestrano= :mue', qrEntradaPacienteMuestrano.Value);
          if qrBuscaAutoriza.RecordCount > 0 then
          begin
              Valida_Afiliado_Simetrica;
              if (Dm.WsArsID = GrupoArsPalic) Or (Dm.WsArsID = GrupoArsSDS) then frmMain.LanzaVentana(-8034);
              If btgrabar.Enabled = True then btgrabar.SetFocus;
      ...
      Begin
       //   Dm.vURLWSDL     := 'http://172.16.30.65/WsPalicTest/Palic.asmx';
          ...
          begin
              Screen.Cursor     := crDefault;
              spMensaje.Visible := False;
              EtMensajeDlg('Prestador Inválido', etAviso, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
              exit;
          end;
          ...
          begin
              if CAfiliadoPal.Val_Afiliado='01' then
                 ...
                 Mensaje:='Póliza Suspendida.  Verifique.'
      ...
      Begin
          ...
          Begin
              ...
              if Trim(CAfiliadoSen.CodMsgDesc) <> EmptyStr then
                 ...
                 EtMensajeDlg('Error validando No. Afiliado ó cédula.  Verifique.', etAviso, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
              exit;
          end;
...
procedure TfrmPuntoVentaMod.btcancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.btCancelarNCFClick(Sender: TObject);
begin
  inherited;
  spImpresionNCF.Visible := False;
end;

procedure TfrmPuntoVentaMod.btCancelClick(Sender: TObject);
begin
  inherited;
  spDoctor.Visible := False;
end;

procedure TfrmPuntoVentaMod.btclienteClick(Sender: TObject);
...
procedure TfrmPuntoVentaMod.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.btentradaClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
procedure TfrmPuntoVentaMod.btgrabarClick(Sender: TObject);
Var
...
begin
 ...
 begin
      ...
      begin
          DM.Warning('Continuará la operacion sin registar el paciente.');
      end
      Else
...
{       Cod_Prueba:=Dm.Verifica_Cliente_Inv_Ameba(qrEntradaPacienteClienteID.Value,qrEntradaPacienteRecid.AsString,'IA');
   ...
   If (qrEntradaPaciente.State in [dsEdit, dsInsert]) And (qrEntradaPacienteCod_Diag.Value = EmptyStr) And
      (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoSeg.Value) then
   Begin
     EtMensajeDlg('Favor seleccionar el diagnóstico del paciente. Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
     eddiagn.Setfocus;
     Exit;
   end;
...
{    If (qrEntradapacienteTotalPendiente.AsFloat > 0) Then
    ...
    begin
       ...
       sqlString := sqlString + ' And RecID ='+#39+IntToStr(Recid)+#39;
           ...
           begin
                ...
                begin
                   Try
                     ...
                     InterfaseAS400.ASConnection.Open;
                     //Insertando las Pruebas en el AS-400.
                     InterfaseAS400.MandarPruebaAS400(Muestrano, qrEntradaPacientePacienteId.Value);
                     InterfaseAS400.ASConnection.Close;
                   except
                     Raise exception.CreateFmt(' Existe un Problema de Comunicacion Con el Servidor AS-400. '+ #13 +
                                               ' Por Favor, LLame al Departamento de Computos. '+ #13 +
...
procedure TfrmPuntoVentaMod.BtHoldClick(Sender: TObject);
begin
 inherited;
...
procedure TfrmPuntoVentaMod.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntradaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaMod.btnCancelaClick(Sender: TObject);
begin
  inherited;
  spBeneficiario.Visible := False;
end;

procedure TfrmPuntoVentaMod.btnOkClick(Sender: TObject);
...
procedure TfrmPuntoVentaMod.btnotacreditoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.btpacienteClick(Sender: TObject);
begin
  inherited;
    If not ((Trim(qrEntradaPacienteEntradaid.value) ='') Or (Copy(qrEntradaPacienteEntradaid.value,1,3)='HOL')) then
    begin
...
procedure TfrmPuntoVentaMod.btpruebaClick(Sender: TObject);
begin
  inherited;
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaMod.FormActivate(Sender: TObject);
begin
  inherited;
  Factura_St := 'M';
end;

procedure TfrmPuntoVentaMod.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.FormDestroy(Sender: TObject);
begin
  lcGeneral.LookAndFeel.GroupOptions.Color := $00F8E3D1;
  If qrEntradaPacienteEntradaID.Value = EmptyStr then
  begin
...
procedure TfrmPuntoVentaMod.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaMod.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaMod.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaMod.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaMod.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.NuevaVenta;
begin
  With qrEntradaPaciente, sql do
  begin
    Close;
...
procedure TfrmPuntoVentaMod.HabilitaConsultas;
begin
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteAfterPost(DataSet: TDataSet);
Var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteClienteIDChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  DM.qrParametro.close;
  DM.qrParametro.open;
      ...
      If (qrEntradaPacienteOrigen.Value <> DM.qrParametroGrupoExt.Value) Then
        Begin
          ...
          begin
            ...
            begin
               qrentradapacienteClienteid.value := qrentradapacientePacienteId.value ;
               qrentradapacienteNeto.value      := qrentradapacienteBruto.value;
               qrEntradaPacienteDetalle.First;
               While not qrEntradaPacienteDetalle.Eof Do
                begin
                   qrEntradaPacienteDetalle.Edit;
                   ...
                   qrEntradaPacienteDetalleCoberturaAplicada.Value:= 0;
                   qrEntradaPacienteDetalle.Next
                end;
//               No_Cambio_Precio :='1';
            end;
          ...
          else if not((qrentradapacienteorigen.value = dm.qrParametroGrupoPriv.Value) or
                      (qrentradapacienteorigen.value = dm.qrParametroGrupoVip.Value) or
                      (qrentradapacienteorigen.value = '12'))then
          begin
              qrEntradaPacienteDescuento.Value := 0;
              qrEntradaPacienteDescuentoPorc.Value := 0;
              qrEntradaPacienteDescuentoValor.Value := 0;
              qrEntradaPacienteDescAutorizadoPor.value := EmptyStr;
          end;
          if qrentradapacienteorigen.value <> dm.qrParametroGrupoSeg.Value then
          begin
              qrEntradaPacienteCOBERTURAPORC.value:=0;
...
procedure TfrmPuntoVentaMod.qrEntradaPacientePACIENTEIDValidate(Sender: TField);
begin
  inherited;
  Buscar_Cliente;
  Val_Paciente;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
  qrEntradaPaciente.Edit;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Val_Descuento;
//  VerificarPagoDiferencia;
...
procedure TfrmPuntoVentaMod.BalanceActual1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.VerTransacciones1Click(Sender: TObject);
begin
  inherited;
  If (qrEntradaPacientePacienteId.Value <> '') Or
  Not(qrEntradaPacientePacienteId.IsNull) Then
...
procedure TfrmPuntoVentaMod.Val_Exterior;
begin
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVentaMod.Val_Paciente;
begin
  DM.qrParametro.close;
  DM.qrParametro.open;
...
procedure TfrmPuntoVentaMod.Val_Forma_Pago(Forma_Pago: string);
begin
 LbCondicion.Caption := '';
...
procedure TfrmPuntoVentaMod.Leer_Forma_Pago;
begin
 LbCondicion.Caption := '';
...
procedure TfrmPuntoVentaMod.Val_Balance;
begin
      if not((qrEntradaPacientePacienteId.Value ='00029127') or (qrEntradaPacientePacienteId.Value ='00008805') or
         (qrEntradaPacientePacienteId.Value ='00018822') or (qrEntradaPacientePacienteId.Value ='00029448') or
         (qrEntradaPacientePacienteId.Value ='00006242')) then
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetalleBeforeDelete(DataSet: TDataSet);
begin
  inherited;
  //Pruebas de los Seguros.
  curCoberturaAplicada := DM.CurCoberturaAplicada(qrEntradaPacienteRECID.Value); //DM.CurCoberturaAplicada(_recorId)
                ...
                begin
                   ...
                   begin
                       ...
                       begin
                           ...
                           begin
                               InterfaseAS400.ASConnection.Close;
                               EtMensajeDlg('Prueba NO puede eliminarse Ya está reportado su Resultado.  Verifique Departamento Técnico.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true);
                               Abort;
                           end
                           else
                               EtMensajeDlg('Vas a eliminar Prueba con resultado Ya reportado.  Verifique Departamento Técnico.', etError, [etOk],0, dm.Imagenes.Items[6].Bitmap,true);
                       end;
                   end
                   else
                       No_Procesar_AS400;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
  comboborrar := False;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
  comboborrar := False;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
 inherited;
 If qrEntradaPacienteDetalle.State in [dsEdit, dsInsert] then
  Begin
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetalleCalcFields(
  DataSet: TDataSet);
begin
  inherited;
  If qrEntradaPacienteEntradaID.Value <> EmptyStr then
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetalleDescuentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
Var
 valor_precio       : Double;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteDoctorIDChange(Sender: TField);
begin
  inherited;
//  Buscar_Doctor;
end;

procedure TfrmPuntoVentaMod.EdDoctorDblClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7984);
end;

procedure TfrmPuntoVentaMod.EdDoctorPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor;
end;

procedure TfrmPuntoVentaMod.EdNombreDoctorDblClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7984);
end;

procedure TfrmPuntoVentaMod.Buscar_Doctor;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaMod.Buscar_Diagnostico;
begin
  inherited;
...
procedure TfrmPuntoVentaMod.Buscar_Doctor_Cambio;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteNombrePacienteValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
 inherited;
...
procedure TfrmPuntoVentaMod.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.Materiales1Click(Sender: TObject);
begin
  inherited;
...
function TfrmPuntoVentaMod.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaMod.Buscar_Linea: Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.MenuItem1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.ActTotales;
Var
 qfind : TADOQuery;
begin
 If (qrEntradaPacienteDetalle.RecordCount > 0) Then
...
procedure TfrmPuntoVentaMod.AsignarDescuentoAutorizadoporCobros1Click(
  Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.AsignarDescuentoPermitidoalEmpleado1Click(
  Sender: TObject);
begin
  inherited;
  If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoSeg.Value) And
  ...
  begin
      ...
      Begin
          if Not DM.Empleado_Existe(qrEntradaPacientePacienteID.Value) And (Dm.CurDescuentoTope = 0) then
            EtMensajeDlg('Empleado ('+qrEntradaPacienteNombrePaciente.Value+') NO pertenece a este Grupo ó no está activo.  Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true)
          else
  ...
  begin
            EtMensajeDlg('Orden sólo aplicable a Tipo-Cliente Seguros con Paciente=Empleado Referencia y Asignado el Monto Cobertura del Seguro.  Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true)
  end;
end;

procedure TfrmPuntoVentaMod.AsignarDescuentoPermitidoalUsuario1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.AsignarDescuentoTarjeta1Click(Sender: TObject);
begin
  inherited;
//  if dm.Verifica_Pago(inttostr(qrEntradaPacienteRecid.value)) = 0 then
    frmMain.LanzaVentana(-7989,1)
{  else
    EtMensajeDlg('Entrada No puede aplicar % descuento, realizó pago factura.  Verifique.', etError, [etOk],0, dm.Imagenes.Items[4].Bitmap,true)
}
end;

procedure TfrmPuntoVentaMod.RecalcularLineas;
begin
 qrEntradaPacienteDetalle.DisableControls;
 qrEntradaPacienteDetalle.First;
...
procedure TfrmPuntoVentaMod.RecibodeCobro1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.EliminarDescuentoAplicado1Click(Sender: TObject);
begin
  inherited;
  qrEntradaPaciente.Edit;
  qrEntradaPacienteDescuentoPorc.Value := 0;
...
procedure TfrmPuntoVentaMod.EliminarOrdenesenHold1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.MarcarPruebaNOProcesar1Click(Sender: TObject);
begin
  inherited;
  No_Procesar;
end;
...
function TfrmPuntoVentaMod.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaMod.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmPuntoVentaMod.Devoluciones1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991, qrEntradaPacienteRECID.asstring,'DV');
end;

procedure TfrmPuntoVentaMod.DistribucionCobrado1Click(Sender: TObject);
begin
  inherited;
     frmMain.LanzaVentana(-7981);
     if (Tiene_Balance = 0) Then
...
procedure TfrmPuntoVentaMod.edbuscarExit(Sender: TObject);
begin
  inherited;
  if (edbuscar.Text <> '') then
    BuscarDoctor;
end;
procedure TfrmPuntoVentaMod.BuscarDoctor;
...
procedure TfrmPuntoVentaMod.EdCoberturaValorExit(Sender: TObject);
begin
  inherited;
  Act_Cobertura
end;
...
procedure TfrmPuntoVentaMod.EDDIAGNPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Diagnostico;
end;

procedure TfrmPuntoVentaMod.Act_Cobertura;
begin
 if qrEntradaPaciente.State in [dsedit, dsinsert] then
  begin
    qrEntradaPacienteDescuentoValor.Value := 0;
...
function TfrmPuntoVentaMod.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.GastosVarios1Click(Sender: TObject);
begin
  inherited;
 If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoExt.Value) Or
    (qrEntradaPacienteTipoDocumento.Value = 3) Or
...
function TfrmPuntoVentaMod.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
function TfrmPuntoVentaMod.GetEntradaID_Hold : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
procedure TfrmPuntoVentaMod.Boton_Cobrar;
begin
...
procedure TfrmPuntoVentaMod.Viejo_Cobrar;
begin
  inherited;
...
procedure TfrmPuntoVentaMod.CotizaFacturaClick(Sender: TObject);
begin
  inherited;
  If Copy(qrEntradaPacienteEntradaid.value,1,3)='HOL' Then
  begin
      ...
      ppImpCotizacion.PrinterSetup.Orientation  := poLandscape;
      ppImpCotizacion.DeviceType                := dtScreen;
      ppImpCotizacion.Print;
  end;
end;

procedure TfrmPuntoVentaMod.CrearCobro;
Var
 qinsert    : TADOQuery;
...
procedure TfrmPuntoVentaMod.RefrescarCobro;
Var
 sql   : String;
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaMod.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
Function TfrmPuntoVentaMod.buscar_valores;
Var
  valor : Boolean;
begin
  valor := True;
...
procedure TfrmPuntoVentaMod.correccion;
begin
  mdPago.First;
  While Not mdPago.Eof do
   Begin
...
function TfrmPuntoVentaMod.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmPuntoVentaMod.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
// cobroid := IntToStr(DM.Get_Secuencia('Secuencia'));
...
procedure TfrmPuntoVentaMod.CrearDevolucion(Tipo: String;UserId: String);
Var
 qinsert : TADOQuery;
begin
// cobroid := IntToStr(DM.Get_Secuencia('Secuencia'));
...
procedure TfrmPuntoVentaMod.ActNotaCredito;
Var
 qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
...
procedure TfrmPuntoVentaMod.ActDevolucion;
Var
 qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
...
procedure TfrmPuntoVentaMod.CrearNotaDebito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVentaMod.ActNotaDebito;
Var
qupdate    : TADOquery;
 qfindcobro : TADoQuery;
begin
...
procedure TfrmPuntoVentaMod.VolantedePruebasARS1Click(Sender: TObject);
begin
  inherited;
//  Application.ProcessMessages;
    Buscar_Cliente;
...
procedure TfrmPuntoVentaMod.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
//  Application.ProcessMessages;
  if Trim(qrEntradaPacienteEntradaID.Value) <> EmptyStr then
...
procedure TfrmPuntoVentaMod.vwDiagnosticoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.vwDoctoresKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if Key = VK_RETURN then
...
procedure TfrmPuntoVentaMod.FacturaconNCF1Click(Sender: TObject);
begin
  inherited;
      qrEntradaPaciente.refresh;
...
procedure TfrmPuntoVentaMod.FacturaExterior1Click(Sender: TObject);
begin
//  Application.ProcessMessages;
...
procedure TfrmPuntoVentaMod.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := _recorId;
  qrEntradaPaciente.Open;
...
procedure TfrmPuntoVentaMod.ActInterface;
begin
{
 Act_Hold;
...
//         if qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value then
         if (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value) Or
           ...
           begin
             CxDBTextEdiT11.Enabled := True;
             CxDBTextEdiT12.Enabled := True;
...
procedure TfrmPuntoVentaMod.RefrescarInterface;
begin
  If ( CanMenuEspecial = True ) Then
 ...
 If (qrEntradaPacienteOrigen.value = DM.qrParametroGrupoPriv.value) Or
    (qrEntradaPacienteOrigen.value = DM.qrParametroGrupoEmp.value) And
    (qrEntradaPacienteTotalPendiente.Value > 0) And
    (qrEntradaPacienteDescuento.Value = 0) then
 begin
    AsignarDescuentoPermitidoalUsuario1.Enabled  := True;
    AsignarDescuentoTarjeta1.Enabled  := True;
 end
 else if (qrEntradaPacienteOrigen.value = DM.qrParametroGrupoSeg.value) And
         (qrEntradaPacienteTotalPendiente.Value > 0) And
         (qrEntradaPacienteDescuento.Value = 0) then
 begin
...
procedure TfrmPuntoVentaMod.Val_Descuento;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
 Buscar_Cliente;
...
procedure TfrmPuntoVentaMod.VerificarPagoDiferencia;
Var
 qfind : TADOQuery;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
...
function TfrmPuntoVentaMod.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
function TfrmPuntoVentaMod.CanMenuEspecial;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaMod.Asignar_Descuento;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaMod.Act_Hold;
var
 qfind : TADOQuery;
begin
{
...
//Eliminando Los Documentos en Hold.
procedure TfrmPuntoVentaMod.Del_Hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.DepositosSucursales1Click(Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.No_Procesar;
Var
 qact : TADOQuery;
begin
{
...
procedure TfrmPuntoVentaMod.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.Buscar_Muestra;
Var
 Dias   : Extended;
 qfind  : TADOQuery;
begin
...
//Validando Los Datos de la 2da. Muestra.
procedure TfrmPuntoVentaMod.Val_2da_Muestra;
Var
 qfind  : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.Buscar_Combo;
begin
...
procedure TfrmPuntoVentaMod.Borrar_Combo;
begin
...
procedure TfrmPuntoVentaMod.Actu_Precio_Combo;
Var
  valor : Double;
  qfind : TAdoQuery;
Begin
...
procedure TfrmPuntoVentaMod.Insertar_Combo_Precio;
begin
...
procedure TfrmPuntoVentaMod.Insertar_Combo_Blanco;
begin
 While Not qfindcombo.Eof Do
  Begin
   If (qrEntradaPacienteDetallePruebaID.Value = '') Or
...
procedure TfrmPuntoVentaMod.Act_Cliente;
Var
  texto       : String;
...
//Buscando los Datos del Cliente a Facturar y Sus Parametros.
procedure TfrmPuntoVentaMod.Buscar_Cliente;
begin
// If (qrEntradaPacienteClienteId.Value <> '') then
//  Begin
...
//Buscando los Datos del PACIENTE Registrado y Sus Parametros.
procedure TfrmPuntoVentaMod.Buscar_Paciente;
begin
...
//Buscando los Datos del Grupo del Cliente.
Procedure TfrmPuntoVentaMod.Buscar_Grupo_Clt(Grupo: string);
begin
...
//Buscando los Datos del Grupo del Paciente.
Procedure TfrmPuntoVentaMod.Buscar_Grupo_Pac(Grupo: string);
begin
...
procedure TfrmPuntoVentaMod.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
//Insertando Los Datos de la Tarjeta de Descuento.
procedure TfrmPuntoVentaMod.Insert_Card_Descuento;
...
procedure TfrmPuntoVentaMod.InstructivodeInternet1Click(Sender: TObject);
...
procedure TfrmPuntoVentaMod.ppCabeFactSeguroBeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.ppHeaderBand4BeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaMod.ppHeaderBand5BeforePrint(Sender: TObject);
Var Texto1, Texto2 : String;
begin
 Texto1 := '';
 Texto2 := '';
...
procedure TfrmPuntoVentaMod.ppHeaderBand6BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.ppImpFactPacienteSinSeguroBeforePrint(
  Sender: TObject);
begin
  inherited;
  Buscar_Cliente;
  ...
  case qfindCltParams.FieldByName('GrupoCliente').AsInteger of
     1,2,3,4,5,8,10,12  :Begin
            pplabel264.Caption:='FACTURA PACIENTE';
        End;
     7  :Begin
            pplabel264.Caption:='FACTURA LAB. CLIENTES';
         End;
     9  :Begin
  ...
  begin
    if qrEntradaPacienteNO_INDICACION.Value = True then
       ppMemo6.Top := 2.1979001
    else
       ppMemo6.Top := 1.8645999;
...
procedure TfrmPuntoVentaMod.ppImpInternetBeforePrint(Sender: TObject);
Var I : Integer;
    qSerial : TADOQuery;
begin
  qSerial := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.ppSummaryFacturaSeguroBeforePrint(Sender: TObject);
Var I : Integer;
    qSerial : TADOQuery;
begin
...
procedure TfrmPuntoVentaMod.ppSummaryBand4BeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaMod.ppSummaryFactPacienteConSeguroBeforePrint(Sender: TObject);
Var qSerial : TADOQuery;
begin
  inherited;
  Buscar_Cliente;
...
procedure TfrmPuntoVentaMod.ppSummaryFactPacienteSinSeguroBeforePrint(Sender: TObject);
Var qSerial : TADOQuery;
begin
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVentaMod.ppSummaryFactPacienteNCFBeforePrint(Sender: TObject);
Var qSerial : TADOQuery;
begin
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVentaMod.ppDetailBandFactNCFBeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.ppDetailBand3BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.ppDetailBand4BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaMod.ppDetailBandSinSeguroBeforePrint(Sender: TObject);
...
procedure TfrmPuntoVentaMod.ppDetailBandConSeguroBeforePrint(Sender: TObject);
begin
  qfindPrueba := DM.Find_Ldr('SELECT * FROM PtPrueba (nolock) WHERE PruebaID = :pru', qrEntradaPacienteDetallePruebaId.Value);
  If qfindPrueba.FieldByName('Font_Bold').Value = True Then
...
procedure TfrmPuntoVentaMod.Insertar_Materiales_Prueba;
Var
...
procedure TfrmPuntoVentaMod.Insertar_Materiales_Envase;
Var
 qfind, qinsert : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.Insertar_Materiales_Sangre;
Var
 qfind, qinsert : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaMod.BuscarDia(dia: Integer) : Integer;
Var
 valor : Integer;
begin
 valor := 0;
...
function TfrmPuntoVentaMod.FechaPrometida(Prueba: string) : TDate;
Var
 fecha : TDate;
 qtest : TADOQuery;
 qfrec : TADOQuery;
...
procedure TfrmPuntoVentaMod.Insertar_LabelTemp;
Var
 Valor      : String;
 Qinsert    : TADOQuery;
begin
...
function TfrmPuntoVentaMod.Validar_Label_Temp(_paciente: String; _entrada: String;
                                           _muestra: String; _prueba: String): Boolean;
Var
 qfind : TADOQuery;
 valor : Boolean;
...
procedure TfrmPuntoVentaMod.Crear_Labels_Temp(_secuenciaact: integer);
Var
 qbuscar  : TADOQuery;
begin
 _total_sangre  := 0;
...
procedure TfrmPuntoVentaMod.Buscar_Label_Temp(_paciente: String; _sucursal: String; _entrada: String;
                                           _muestra: String; TipoMuestra: String; _departamento: String;
                                           _medio: String; _color: String; _total: Integer);
Var
 qdata  : TADOQuery;
...
//Insertando la Prueba Registrada en la Tabla Temporal
procedure TfrmPuntoVentaMod.Update_Label_Temp(_paciente: String; _entrada: String; _muestra: String;
                                           _prueba: String; _label: String; _labelglobal: String;
                                           _labelunico: String; _desc: String; _recid: Int64;
                                           _secuencia: Integer; _numero: Integer);
Var
...
procedure TfrmPuntoVentaMod.Update_Label_Descripcion(_label: String; _descripcion: String);
Var
 qactu    : TADOQuery;
begin
  qactu := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.Generar_Labels;
Begin
{
  Insertar_LabelTemp;
...
procedure TfrmPuntoVentaMod.Confirmar_Cliente_Prueba;
Var
  qfind1  : TADOQuery;
  qfind2  : TADOQuery;
begin
...
procedure TfrmPuntoVentaMod.Confirmar_Precio_Prueba;
Var
 valor_precio     : Double;
 qprueba          : TADOQuery;
...
procedure TfrmPuntoVentaMod.Agregar_Pacientes(PacienteId : String);
Var
 sqlString : String;
...
// If ( qrEntradaPaciente.State in [dsinsert,dsedit] ) Then
 If ( (qrEntradaPaciente.State in [dsinsert,dsedit]) ) And
  ...
  Begin
   ...
   sqlString := ' SELECT top 1 * FROM PTCliente WHERE GrupoCliente (nolock) IN (' + #39 +
...
procedure TfrmPuntoVentaMod.Agregar_Clientes(ClienteId : String);
Var
 sqlString : String;
...
//      qrentradaPacientePublicarInternet.value := DM.qrPacientesPublicarInternet.Value;
      ...
      If qrEntradaPacienteCoberturaPorc.Value > 1 then
        begin
          qrEntradaPacienteCoberturaConfirmada.Value := 0;
...
Function TfrmPuntoVentaMod.Cargar_Valor(campo: String; valor: Variant): String;
begin
 Result := campo + ' - ( ' + VarToStr(valor) + ' ).';
end;


procedure TfrmPuntoVentaMod.Mirar_Valor_CAB;
Var idx : Integer;
begin
...
procedure TfrmPuntoVentaMod.Mirar_Valor_DET;
Var idx : Integer;
begin
...
procedure TfrmPuntoVentaMod.mskRNCExit(Sender: TObject);
...
procedure TfrmPuntoVentaMod.Act_RecIdDetalle;
begin
...
procedure TfrmPuntoVentaMod.GridPruebasEntradasPacienteDetComentarioPropertiesInitPopup(
  Sender: TObject);
Var
 qfind : TADOQuery;
...
procedure TfrmPuntoVentaMod.GridPruebasEntradasPacienteDetResultadoStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.GridPruebasEntradasPacienteDetStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  inherited;
...
procedure TfrmPuntoVentaMod.Cancelar_Entrada;
begin
 If qrEntradaPaciente.State = dsinsert then
  begin
    If qrEntradaPacienteEntradaID.Value = EmptyStr then
...
procedure TfrmPuntoVentaMod.Guardar_Entrada;
begin
 inherited;
 Confirmar_Cliente_Prueba;
 Val_Paciente;
...
procedure TfrmPuntoVentaMod.HTTPRIO1AfterExecute(const MethodName: string;
  SOAPResponse: TStream);
var
  XMLDoc: IXMLDocument;
begin
...
procedure TfrmPuntoVentaMod.Re_Grabar;
begin
 DM.qrParametro.close;
 DM.qrParametro.open;
...
procedure TfrmPuntoVentaMod.Procesar_Usuario_New;
Var
  Valor : Boolean;
...
Function TfrmPuntoVentaMod.Crear_Clave(cedularnc : String) : Integer;
Var
  Numero  : Double;
  Valor   : Int64;
//  Valor   : Integer;
...
//Creando el Usuario de Internet.
Function TfrmPuntoVentaMod.Crear_Usuario(nombre : String) : String;
Var
  Texto : String;
...
Function TfrmPuntoVentaMod.Valida_Usuario(usuario : String) : Boolean;
Var
 qfind  : TAdoQuery;
begin
...
procedure TfrmPuntoVentaMod.Insertar_Usuario_New(usuario: string; clave: string; name: string; cedula: string;
...
//Validando la Existencia del Usuario Creado.
Function TfrmPuntoVentaMod.Buscar_User_Internet(_customer : String) : Boolean;
Var
 qinter  : TAdoQuery;
begin
  qinter := DM.NewQuery;
...
procedure TfrmPuntoVentaMod.Insertar_Pago_AS400_PuntodeVenta;
Var
  _fecha     : String;
  monto      : Double;
  qfind      : TADOQuery;
...
function TfrmPuntoVentaMod.GetReciboAS400(tipodoc : string; _sucursal : String; _sucAS400: Integer) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
function TfrmPuntoVentaMod.GetSecuenciaAS400(_sucursal : String; _sucAS400: Integer) : Integer;
Var
 _valor   : String;
 numero   : Int64;
 qsecdoc  : TADOQuery;
...
procedure TfrmPuntoVentaMod.RecibosdelAS4001Click(Sender: TObject);
begin
...
Procedure TfrmPuntoVentaMod.Buscar_Campos_Extras(ClienteId :String;Tipo : String);
var
 qfind2 : TADOQuery;
begin
 qfind2 := DM.NewQuery;
 ...
 begin
  ...
  begin
         ...
         Begin
           ...
           ppLabel228.caption := fieldbyname('Nombre_Sucursal').value;
         ...
         Begin
           ...
           ppLabel230.caption := fieldbyname('Nombre_Sucursal').value;
         ...
         Begin
           ...
           ppLabel231.caption := fieldbyname('Nombre_Sucursal').value;
         ...
         Begin
           ...
           ppLabel229.Caption := fieldbyname('Nombre_Sucursal').value;
         ...
         Begin
           ppLabel232.Caption := fieldbyname('Nombre_Sucursal').value;
           ppLabel44.caption  := fieldbyname('Identificacion').value;
         end;
   end;
 End;
 FreeAndNil(qfind2);
end;
procedure TfrmPuntoVentaMod.No_Procesar_AS400;
Var
  qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaMod.No_Procesar_AS400_Orden;
Var
  qact : TADOQuery;
begin
...
procedure TfrmPuntoVentaMod.ImpresionRwPrint;
var
 PP, LabelPOs : Integer;
...
Function TfrmPuntoVentaMod.Estremos(TextE1,TextE2 : String ; LengE :SmallInt):String ;
...
Function TfrmPuntoVentaMod.Verifica_Comentario_Coberturas : integer;
Var
 qfind : TADOQuery;
 strsql : String;
begin
...
Function TfrmPuntoVentaMod.Verifica_Orden_Pruebas_Paternidad : integer;
Var
 qfind : TADOQuery;
 strsql,strPruebaAnt : String;
 SecAnt : Integer;
...
Function TfrmPuntoVentaMod.BuscaNumeroOrden(CobroID : String) : String;
Var
 qinter  : TAdoQuery;
begin
  qinter := DM.NewQuery;
  ...
  FreeAndNil(qinter);
End;
Function TfrmPuntoVentaMod.Inserta_Detalle_Int : Boolean;
Var
 qDetalle   : TAdoQuery;
 CPagoTotal : Currency;
begin
...
Procedure TfrmPuntoVentaMod.Valida_Afiliado_Simetrica;
...
Begin
          ...
          if Dm.Cod_Doctor = EmptyStr  then Dm.Cod_Doctor := '0';
          ...
          begin
              Screen.Cursor     := crDefault;
              spMensaje.Visible := False;
              if CAfiliado.ErrorSM.CodigoSalida+'-'+CAfiliado.ErrorSM.Descipcion ='02-Póliza suspendida' then
              begin
                  ...
                  if Length(CAfiliado.ErrorSM.Descipcion)>0 then
                  begin
          ...
          if (CAfiliado.Nombre = 'Afiliado no existe') or (CAfiliado.Nombre ='Afiliado excluido') or
             (CAfiliado.Nombre = 'Póliza suspendida')  then
          begin
              Screen.Cursor     := crDefault;
              spMensaje.Visible := False;
