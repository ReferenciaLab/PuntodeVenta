inherited frmPuntoVentaND: TfrmPuntoVentaND
  Caption = 'Facturacion Punto de Venta (OTRA FACTURA)'
  ClientHeight = 625
  ClientWidth = 1007
  KeyPreview = True
  ...
  object dxLayoutControl1: TdxLayoutControl [2]
        ...
        object lcGeneral: TdxLayoutControl
          ...
          object CbDocumento: TcxDBImageComboBox
            ...
            Properties.Items = <
              ...
              item
                Description = 'Nota de Cr'#233'dito'
                Value = 4
              end>
    ...
    object GridPruebas: TcxGrid
      ...
      object GridPruebasEntradasPacienteDet: TcxGridDBTableView
        ...
        OnEditValueChanged = GridPruebasEntradasPacienteDetEditValueChanged
  ...
  object spBeneficiario: TLMDSimplePanel [5]
    Left = 19
    Top = 19
    Width = 967
    Height = 266
  ...
  object spDoctor: TLMDSimplePanel [6]
    ...
    object cgDoctor: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        DataController.Filter.PercentWildcard = '*'
        DataController.KeyFieldNames = 'Seleccion'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <>
        DataController.Summary.SummaryGroups = <>
        OptionsBehavior.IncSearch = True
  ...
  object qrEntradaPaciente: TADOQuery [11]
    ...
    SQL.Strings = (
      'SELECT * FROM PTEntradaPacienteNC (nolock)'
      'WHERE RecId = :rec'
  ...
  object qrEntradaPacienteDetalle: TADOQuery [13]
    ...
    SQL.Strings = (
      'SELECT * FROM PTEntradaPacienteDetalleNC  (nolock)'
      'WHERE refrecid = :rec'
      'AND Ncr_Estatus=0'
      'AND DataAreaId = '#39'ldr'#39
      'ORDER BY secuencia')
  ...
  object ppEntradaPaciente: TppDBPipeline [16]
    ...
    object ppEntradaPacienteppField115: TppField
    ...
    object ppEntradaPacienteppField116: TppField
    ...
    object ppEntradaPacienteppField117: TppField
      FieldAlias = 'NO_INDICACION'
      FieldName = 'NO_INDICACION'
      FieldLength = 0
      DataType = dtBoolean
      DisplayWidth = 5
    ...
    object ppEntradaPacienteppField118: TppField
